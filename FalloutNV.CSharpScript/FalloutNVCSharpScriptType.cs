...
namespace Nexus.Client.Games.FalloutNV.Scripting.CSharpScript
{
	...
	public class FalloutNVCSharpScriptType : CSharpScriptType
	{
		...
		protected override CSharpScriptFunctionProxy GetScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, SynchronizationContext p_scxUIContext)
		{
			...
			return new FalloutNVCSharpScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, bmgBsaManager, uitUiUtilities);
		}
	}
}
