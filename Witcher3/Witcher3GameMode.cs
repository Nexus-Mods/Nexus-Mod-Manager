...
using Nexus.Client.Games.Witcher3.Settings;
using Nexus.Client.Games.Witcher3.Settings.UI;
using Nexus.Client.Games.Witcher3.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage Witcher3 game's plugins and mods.
	/// </summary>
    public class Witcher3GameMode : GameModeBase
	{
		...
		/// <summary>
        /// Gets the path to the per user Witcher3 data.
		/// </summary>
        /// <value>The path to the per user Witcher3 data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
                    m_glnGameLauncher = new Witcher3Launcher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
                    m_gtlToolLauncher = new Witcher3ToolLauncher(this, EnvironmentInfo);
		...
		public Witcher3GameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new Witcher3GameModeDescriptor(EnvironmentInfo);
