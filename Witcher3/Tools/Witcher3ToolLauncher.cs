...
namespace Nexus.Client.Games.Witcher3.Tools
{
    /// <summary>
    /// Exposes the tools for Witcher3.
    /// </summary>
    public class Witcher3ToolLauncher : IToolLauncher
    {
		...
		public Witcher3ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
