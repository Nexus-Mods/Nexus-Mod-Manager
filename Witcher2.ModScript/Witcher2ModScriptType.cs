...
{
    /// <summary>
	/// Describes the The Witcher 2 variant of the Mod Script type.
    /// </summary>
    public class Witcher2ModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
            return new Witcher2ModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
