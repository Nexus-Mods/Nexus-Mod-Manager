...
namespace Nexus.Client.Games.Witcher2.Scripting.ModScript
{
    ...
    public class Witcher2ModScriptFunctionProxy : ModScriptFunctionProxy
    {
        ...
        public Witcher2ModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
