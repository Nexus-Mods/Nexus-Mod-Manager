...
{
    /// <summary>
    /// Implements the functions availabe to the The Witcher 2 variant of Mod Script scripts.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class Witcher2ModScriptFunctionProxy : ModScriptFunctionProxy
    {
        #region Constructors
		...
		public Witcher2ModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
        ...
        public bool Witcher2NewerThan(string p_strGameVersion)
        {
        ...
        {
            return ((Witcher2GameMode)GameMode).ScriptExtenderVersion;
        }
