...
{
    /// <summary>
    /// Interpets and executes the given WorldOfTanks Mod Script script.
    /// </summary>
    public class WoTModScriptInterpreter : ModScriptInterpreter
    {
        #region Constructors
        ...
        public WoTModScriptInterpreter(ModScriptFunctionProxy p_msfFunctions, string p_strScript)
        ...
        {
            return new WoTModScriptInterpreterContext(p_msfFunctions);
        }
    }
}
