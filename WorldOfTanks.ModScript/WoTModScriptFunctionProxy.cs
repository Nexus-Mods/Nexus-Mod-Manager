...
{
    /// <summary>
    /// Implements the functions availabe to the WorldOfTanks variant of Mod Script scripts.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class WoTModScriptFunctionProxy : ModScriptFunctionProxy
    {
        #region Constructors
        ...
        public bool WoTNewerThan(string p_strGameVersion)
        {
        ...
        {
            return ((WoTGameMode)GameMode).ScriptExtenderVersion;
        }
