...
{
    /// <summary>
    /// Describes the WorldOfTanks variant of the Mod Script type.
    /// </summary>
    public class WoTModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
			return new WoTModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
