...
using Nexus.Client.Games.XRebirth.Settings;
using Nexus.Client.Games.XRebirth.Settings.UI;
using Nexus.Client.Games.XRebirth.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage XRebirth's mods.
	/// </summary>
	public class XRebirthGameMode : GameModeBase
	{
		private XRebirthGameModeDescriptor m_gmdGameModeInfo = null;
		private XRebirthLauncher m_glnGameLauncher = null;
		private XRebirthToolLauncher m_gtlToolLauncher = null;
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new XRebirthLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new XRebirthToolLauncher(this, EnvironmentInfo);
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new XRebirthGameModeDescriptor(EnvironmentInfo);
