...
namespace Nexus.Client.Games.Gamebryo.PluginManagement.Boss
{
	...
	/// </remarks>
	public class BossSorterCore : IBossSorter, IDisposable
	{
		...
		public BossSorterCore(IEnvironmentInfo p_eifEnvironmentInfo, GamebryoGameModeBase p_gmdGameMode, FileUtil p_futFileUtility, string p_strMasterlistPath)
		{
