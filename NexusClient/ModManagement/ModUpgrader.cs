...
namespace Nexus.Client.ModManagement
{
	...
	public class ModUpgrader : ModInstaller
	{
		...
		{
			return new ModFileUpgradeInstaller(GameMode.GameModeEnvironmentInfo, Mod, ModInstallLog, PluginManager, new DataFileUtil(GameMode.GameModeEnvironmentInfo.InstallationPath), p_tfmFileManager, p_dlgOverwriteConfirmationDelegate);
		}
