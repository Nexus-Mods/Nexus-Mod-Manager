	...
	internal sealed class TreeModListSurface : IModCategorySurface
	{
		...
		private object GetModColumnValue(IMod mod, string fieldName)
		{
			switch (fieldName)
			{
				...
				case ModCategoryTreeColumns.SortNumber: return _sortNumberResolver(mod);
		...
		private bool UpdateModNode(TreeListNode node, IMod mod)
		{
			...
			changed |= SetValueIfChanged(node, ModCategoryTreeColumns.SortNumber, _sortNumberResolver(mod));
