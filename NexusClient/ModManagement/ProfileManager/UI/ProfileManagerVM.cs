...
namespace Nexus.Client.ModManagement.UI
{
	...
	public class ProfileManagerVM
	{
		...
		public ProfileManagerVM(IProfileManager p_mmdProfileManager, ReadOnlyObservableList<IMod> p_rolManagedMods, IModRepository p_mmrModRepository, ISettings p_setSettings, Theme p_thmTheme)
		{
			...
			//ProfileManager.UpdateCheckStarted += new EventHandler<EventArgs<IBackgroundTask>>(ProfileManager_UpdateCheckStarted);
		}
		...
		//{
		//	IBackgroundTask bgtAddingTask = ProfileManager.AddMod(p_strPath, ConfirmFileOverwrite);
		//}
		...
		//	{
		//		IBackgroundTaskSet btsInstall = ProfileManager.DeleteMod(p_modMod, ProfileManager.ActiveMods);
		...
		//{
		//	string strErrorMessage = ProfileManager.RequiredToolErrorMessage;
		//	if (String.IsNullOrEmpty(strErrorMessage))
		//	{
		//		if (!ActiveMods.Contains(p_modMod))
		//		{
		//			IBackgroundTaskSet btsInstall = ProfileManager.ActivateMod(p_modMod, ConfirmModUpgrade, ConfirmItemOverwrite, ProfileManager.ActiveMods);
		//			if (btsInstall != null)
		...
		//{
		//	IBackgroundTaskSet btsUninstall = ProfileManager.DeactivateMod(p_modMod, ProfileManager.ActiveMods);
		...
		//	{
		//		DisablingMultipleMods(this, new EventArgs<IBackgroundTask>(ProfileManager.DisableMultipleMods(p_rolModList, ConfirmUpdaterAction)));
		//	}
		//}
		...
		//	{
		//		DeactivatingMultipleMods(this, new EventArgs<IBackgroundTask>(ProfileManager.DeactivateMultipleMods(p_rolModList, ConfirmUpdaterAction)));
		//	}
		//}
		...
		//{
		//	ActivatingMultipleMods(this, new EventArgs<IBackgroundTask>(ProfileManager.ActivateMultipleMods(p_lstModList, p_booAllowCancel, ConfirmUpdaterAction, ConfirmItemOverwrite)));
		//}
		...
		//{
		//	if (!ProfileManager.ModRepository.IsOffline)
		//	{
		//		ModTaggerVM mtgTagger = new ModTaggerVM(ProfileManager.GetModTagger(), p_modMod, Settings, CurrentTheme);
		...
		//		ModTaggerVM mtgTagger = new ModTaggerVM(ProfileManager.GetModTagger(), p_modMod, Settings, CurrentTheme);
		//		ProfileManager.AsyncTagMod(this, mtgTagger, TaggingMod);
		//	}
		//}
		...
		//		{
		//			UpdatingMods(this, new EventArgs<IBackgroundTask>(ProfileManager.UpdateMods(lstModList, ConfirmUpdaterAction, p_booOverrideCategorySetup)));
		//		}
		//	}
		//	else
		//	{
		//		ProfileManager.Login();
		//		ProfileManager.AsyncUpdateMods(lstModList, ConfirmUpdaterAction, p_booOverrideCategorySetup);
		//	}
		//}
		...
		//	if (!ProfileManager.ModRepository.IsOffline)
		//		ProfileManager.ToggleModEndorsement(p_modMod);
		//	else
		//	{
		//		ProfileManager.Login();
		//		ProfileManager.AsyncEndorseMod(p_modMod);
		//	}
		//}
		...
		//{
		//	TogglingAllWarning(this, new EventArgs<IBackgroundTask>(ProfileManager.ToggleUpdateWarningTask(p_hashMods, p_booEnable, ConfirmUpdaterAction)));
		//}
		...
		//{
		//	ProfileManager.SwitchModCategory(p_modMod, p_intCategoryId);
		//}
		...
		//	if (Result == DialogResult.Yes)
		//	{
		//		this.CategoryManager.ResetCategories(ProfileManager.CurrentGameModeDefaultCategories);
		...
		//{
		//	UpdatingCategory(this, new EventArgs<IBackgroundTask>(CategoryManager.Update(ProfileManager, ManagedMods, p_intCategoryId, ConfirmUpdaterAction)));
		//}
		...
		//{
		//	UpdatingCategory(this, new EventArgs<IBackgroundTask>(CategoryManager.Update(ProfileManager, p_lstSelectedMods, p_intCategoryId, ConfirmUpdaterAction)));
		//}
		...
		//	UpdatingCategory(this, new EventArgs<IBackgroundTask>(CategoryManager.Update(ProfileManager, CategoryMods, 0, ConfirmUpdaterAction)));
		//}
		...
		//		if (Result == DialogResult.Yes)
		//		{
		//			this.CategoryManager.LoadCategories(ProfileManager.CurrentGameModeDefaultCategories);
		//			if (!OfflineMode)
		//				CheckForUpdates(true);
		//		}
		//		else
