...
namespace Nexus.Client.Games.Grimrock.Scripting.ModScript
{
    ...
    /// </remarks>
    public class GrimrockModScriptFunctionProxy : ModScriptFunctionProxy
    {
        #region Constructors
		...
		public GrimrockModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
		...
		public bool GrimrockNewerThan(string p_strGameVersion)
        {
        ...
        {
			return ((GrimrockGameMode)GameMode).ScriptExtenderVersion;
        }
