...
namespace Nexus.Client.Games.Grimrock.Scripting.ModScript
{
    ...
    public class GrimrockModScriptFunctionProxy : ModScriptFunctionProxy
    {
		...
		public GrimrockModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
