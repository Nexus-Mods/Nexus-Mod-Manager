...
{
    /// <summary>
	/// Describes the Grimrock variant of the Mod Script type.
    /// </summary>
	public class GrimrockModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
			return new GrimrockModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
