...
namespace Nexus.Client.Games.Grimrock.Scripting.ModScript
{
	...
	public class GrimrockModScriptType : ModScriptType
    {
        ...
        {
			return new GrimrockModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
