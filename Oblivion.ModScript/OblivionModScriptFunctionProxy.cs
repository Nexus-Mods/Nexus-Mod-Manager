...
namespace Nexus.Client.Games.Oblivion.Scripting.ModScript
{
	...
	/// </remarks>
	public class OblivionModScriptFunctionProxy : ModScriptFunctionProxy
	{
		#region Constructors
		...
		public OblivionModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
		...
		public bool OblivionNewerThan(string p_strGameVersion)
		{
