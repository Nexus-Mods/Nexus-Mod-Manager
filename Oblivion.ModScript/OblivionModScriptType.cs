...
{
	/// <summary>
	/// Describes the Oblivion variant of the Mod Script type.
	/// </summary>
	public class OblivionModScriptType : ModScriptType
	{
		/// <summary>
		...
		{
			return new OblivionModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
		}
	}
}
