namespace Nexus.Client.Controls
{
	partial class ExtendedMessageBox
	{
		...
		private Nexus.Client.Controls.AutosizeLabel albPrompt;
		...
		private Nexus.Client.Controls.HtmlLabel hlbDetails;
