...
namespace Nexus.Client.ModManagement.Scripting.ModScript
{
	...
	public class ModScriptType : IScriptType
	{
		...
		{
			ModScriptFunctionProxy msfFunctions = GetScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_igpInstallers, p_scxUIContext);
			return new ModScriptExecutor(p_gmdGameMode, p_eifEnvironmentInfo, msfFunctions);
		}
		...
		protected virtual ModScriptFunctionProxy GetScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, InstallerGroup p_igpInstallers, SynchronizationContext p_scxUIContext)
		{
			return new ModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
		}
	}
}
