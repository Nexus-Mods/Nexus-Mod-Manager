...
using Nexus.Client.Games.XCOM2.Settings.UI;
using Nexus.Client.Games.XCOM2.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage XCOM2 game's plugins and mods.
	/// </summary>
    public class XCOM2GameMode : GameModeBase
	{
		private XCOM2GameModeDescriptor m_gmdGameModeInfo = null;
        private XCOM2Launcher m_glnGameLauncher = null;
        private XCOM2ToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
        /// Gets the path to the per user XCOM2 data.
		/// </summary>
        /// <value>The path to the per user XCOM2 data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
                    m_glnGameLauncher = new XCOM2Launcher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
                    m_gtlToolLauncher = new XCOM2ToolLauncher(this, EnvironmentInfo);
		...
		public XCOM2GameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new XCOM2GameModeDescriptor(EnvironmentInfo);
