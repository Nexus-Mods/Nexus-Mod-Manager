...
using Nexus.Client.Games.DarkSouls2.Settings;
using Nexus.Client.Games.DarkSouls2.Settings.UI;
using Nexus.Client.Games.DarkSouls2.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage DarkSouls2 game's plugins and mods.
	/// </summary>
	public class DarkSouls2GameMode : GameModeBase
	{
		private DarkSouls2GameModeDescriptor m_gmdGameModeInfo = null;
		private DarkSouls2Launcher m_glnGameLauncher = null;
		private DarkSouls2ToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per user DarkSouls2 data.
		/// </summary>
		/// <value>The path to the per user DarkSouls2 data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new DarkSouls2Launcher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new DarkSouls2ToolLauncher(this, EnvironmentInfo);
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new DarkSouls2GameModeDescriptor(EnvironmentInfo);
