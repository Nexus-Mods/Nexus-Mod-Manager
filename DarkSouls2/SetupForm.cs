...
{
	/// <summary>
	/// This is the setup form for the DarkSouls2 game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
		private DarkSouls2SetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
				m_vmlViewModel = value as DarkSouls2SetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a DarkSouls2SetupVM. Type found: " + value.GetType().FullName);
