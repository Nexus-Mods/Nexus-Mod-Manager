...
namespace Nexus.Client.Games.Fallout4.Scripting.XmlScript.Parsers
{
	/// <summary>
	/// Provides Fallout4 specific parsing for version 5.0 xml script files.
	/// </summary>
	public class Fallout4Parser50 : Parser50
	{
		#region Constructors
		...
		public Fallout4Parser50(XElement p_xelScript, XmlScriptType p_xstXmlScriptType)
		...
		{
			return Fallout4Parser20Helper.ParseCondition(p_xelCondition) ?? base.LoadCondition(p_xelCondition);
		}
	}
}
