...
namespace Nexus.Client.ModManagement.Scripting.XmlScript.CPL
{
	...
	public abstract class CPLLexerBase : Lexer
	{
		...
		public CPLLexerBase(ICharStream input, RecognizerSharedState state)
			: base(input, state)
		{
		}
