...
{
    /// <summary>
    /// Implements the functions availabe to the Dragon Age 2 variant of Mod Script scripts.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class DragonAge2ModScriptFunctionProxy : ModScriptFunctionProxy
    {
        #region Constructors
		...
		public DragonAge2ModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
        ...
        public bool DragonAge2NewerThan(string p_strGameVersion)
        {
        ...
        {
            return ((DragonAge2GameMode)GameMode).ScriptExtenderVersion;
        }
