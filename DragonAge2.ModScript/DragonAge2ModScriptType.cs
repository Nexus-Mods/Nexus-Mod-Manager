...
namespace Nexus.Client.Games.DragonAge2.Scripting.ModScript
{
	...
	public class DragonAge2ModScriptType : ModScriptType
    {
        ...
        {
			return new DragonAge2ModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
