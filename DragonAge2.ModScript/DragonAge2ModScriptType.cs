...
{
    /// <summary>
	/// Describes the The DragonAge 2 variant of the Mod Script type.
    /// </summary>
	public class DragonAge2ModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
			return new DragonAge2ModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
