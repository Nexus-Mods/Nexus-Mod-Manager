...
{
	/// <summary>
	/// This is the setup form for the NoMansSky game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private NoMansSkySetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as NoMansSkySetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a NoMansSkySetupVM. Type found: " + value.GetType().FullName);
