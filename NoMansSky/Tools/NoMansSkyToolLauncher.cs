...
{
	/// <summary>
	/// Exposes the tools for NoMansSky.
	/// </summary>
	public class NoMansSkyToolLauncher : IToolLauncher
	{
		...
		public NoMansSkyToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
