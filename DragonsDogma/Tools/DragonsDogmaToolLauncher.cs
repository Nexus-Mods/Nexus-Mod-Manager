...
namespace Nexus.Client.Games.DragonsDogma.Tools
{
	/// <summary>
	/// Exposes the tools for DragonsDogma.
	/// </summary>
	public class DragonsDogmaToolLauncher : IToolLauncher
	{
		...
		public DragonsDogmaToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
