...
{
    /// <summary>
	/// Describes the The DragonAge variant of the Mod Script type.
    /// </summary>
	public class DragonAgeModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
			return new DragonAgeModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
