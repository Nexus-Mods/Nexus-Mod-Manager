...
{
    /// <summary>
    /// Implements the functions availabe to the Dragon Age variant of Mod Script scripts.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class DragonAgeModScriptFunctionProxy : ModScriptFunctionProxy
    {
        #region Constructors
		...
		public DragonAgeModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
        ...
        public bool DragonAgeNewerThan(string p_strGameVersion)
        {
        ...
        {
            return ((DragonAgeGameMode)GameMode).ScriptExtenderVersion;
        }
