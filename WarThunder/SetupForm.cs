...
{
	/// <summary>
	/// This is the setup form for theWarThunder game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
		private WarThunderSetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
				m_vmlViewModel = value as WarThunderSetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be aWarThunderSetupVM. Type found: " + value.GetType().FullName);
