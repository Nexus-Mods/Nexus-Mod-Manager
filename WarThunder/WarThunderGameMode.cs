...
using Nexus.Client.Games.WarThunder.Settings;
using Nexus.Client.Games.WarThunder.Settings.UI;
using Nexus.Client.Games.WarThunder.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage WarThunder game's plugins and mods.
	/// </summary>
	public class WarThunderGameMode : GameModeBase
	{
		private WarThunderGameModeDescriptor m_gmdGameModeInfo = null;
		private WarThunderLauncher m_glnGameLauncher = null;
		private WarThunderToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per userWarThunder data.
		/// </summary>
		/// <value>The path to the per userWarThunder data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new WarThunderLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new WarThunderToolLauncher(this, EnvironmentInfo);
		...
		public WarThunderGameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new WarThunderGameModeDescriptor(EnvironmentInfo);
