...
{
	/// <summary>
	/// Describes the Fallout4 variant of the C# script type.
	/// </summary>
	public class Fallout4VRCSharpScriptType : CSharpScriptType
	{
		#region Properties
		...
		protected override Type BaseScriptType
		{
			get
			{
				return typeof(Fallout4VRCSharpBaseScript);
			}
		}
		...
		{
			BsaManager bmgBsaManager = new BsaManager((Fallout4VRGameMode)p_gmdGameMode);
			UIUtil uitUiUtilities = new UIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext);
			return new Fallout4VRCSharpScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, bmgBsaManager, uitUiUtilities);
		}
	}
}
