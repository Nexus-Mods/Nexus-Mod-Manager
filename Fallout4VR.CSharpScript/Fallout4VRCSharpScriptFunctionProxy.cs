...
namespace Nexus.Client.Games.Fallout4VR.Scripting.CSharpScript
{
	...
	/// </summary>
	public class Fallout4VRCSharpScriptFunctionProxy : FalloutCSharpScriptFunctionProxy
	{
		#region Constructors
		...
		public Fallout4VRCSharpScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, BsaManager p_bamBsaManager, UIUtil p_uipUIProxy)
		...
		{
			return ((Fallout4VRGameMode)GameMode).ScriptExtenderVersion;
		}
