...
namespace Nexus.Client.Games.Fallout4VR.Scripting.XmlScript.Unparsers
{
	/// <summary>
	/// Unparses the Fallout4 variety of the version 5.0 XML scripts.
	/// </summary>
	public class Fallout4VRUnparser50 : Unparser50
	{
		#region Constructors
		...
		public Fallout4VRUnparser50(Nexus.Client.ModManagement.Scripting.XmlScript.XmlScript p_xscScript)
			: base(p_xscScript)
		{
		}
		...
		{
			return Fallout4VRUnparser20Helper.UnparseCondition(p_cndCondition) ?? base.UnparseCondition(p_cndCondition);
		}
	}
}
