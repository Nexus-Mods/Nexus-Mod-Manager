...
using Nexus.Client.Games.Fallout4VR.Scripting.XmlScript.CPL;
using Nexus.Client.Games.Fallout4VR.Scripting.XmlScript.Parsers;
using Nexus.Client.Games.Fallout4VR.Scripting.XmlScript.Unparsers;
...
namespace Nexus.Client.Games.Fallout4VR.Scripting.XmlScript
{
	/// <summary>
	/// Describes the Fallout4 variant of the XML script type.
	/// </summary>
	public class Fallout4VRXmlScriptType : XmlScriptType
	{
		#region Properties
		...
		protected override IParser GetParser(XElement p_xelScript)
		{
			...
			switch (strScriptVersion)
			{
				...
				case "5.0":
					return new Fallout4VRParser50(p_xelScript, this);
			}
		...
		protected override IUnparser GetUnparser(Nexus.Client.ModManagement.Scripting.XmlScript.XmlScript p_xscScript)
		{
			switch (p_xscScript.Version.ToString())
			{
				...
				case "5.0":
					return new Fallout4VRUnparser50(p_xscScript);
		...
		{
			return new Fallout4VRCplParserFactory();
		}
		...
		{
			return new Fallout4VRConditionStateManager(p_modMod, p_gmdGameMode, p_pmgPluginManager, p_eifEnvironmentInfo);
		}
	}
}
