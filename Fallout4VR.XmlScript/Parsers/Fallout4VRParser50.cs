...
namespace Nexus.Client.Games.Fallout4VR.Scripting.XmlScript.Parsers
{
	/// <summary>
	/// Provides Fallout4 specific parsing for version 5.0 xml script files.
	/// </summary>
	public class Fallout4VRParser50 : Parser50
	{
		#region Constructors
		...
		public Fallout4VRParser50(XElement p_xelScript, XmlScriptType p_xstXmlScriptType)
		...
		{
			return Fallout4VRParser20Helper.ParseCondition(p_xelCondition) ?? base.LoadCondition(p_xelCondition);
		}
	}
}
