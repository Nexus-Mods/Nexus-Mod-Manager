parser grammar Fallout4VRCplParser;
...
@parser::members {
	...
	public Fallout4VRCplParser(ITokenStream input, string dummy)
		: base(input, new RecognizerSharedState())
	{
		gCPLImportParser = new Fallout4VRCplParser_CPLImportParser(input, state, this);
