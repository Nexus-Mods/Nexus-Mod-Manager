...
{
	/// <summary>
	/// The highlighting strategy for the Fallout4VR variant of the Conditional Pattern Language.
	/// </summary>
	/// <remarks>
	/// This is used to highilight CPL in the editor.
	/// </remarks>
	public class Fallout4VRCplHighlightingStrategy : CplHighlightingStrategy
	{
		#region Constructors
		...
		public Fallout4VRCplHighlightingStrategy(ICplParserFactory p_cpfLexerFactory)
		...
		protected override TokenClass GetTokenClass(int p_intTokenType)
		{
			...
			{
				case Fallout4VRCplLexer.SKSE_VERSION:
