...
namespace Nexus.Client.Games.Fallout4VR.Scripting.XmlScript.CPL
{
	...
	/// </summary>
	public class Fallout4VRCplParserFactory : ICplParserFactory
	{
		...
		public AntlrParserBase CreateParser(string p_strCode, ErrorTracker p_ertErrorTracker)
		{
			...
			Fallout4VRCplParser prsParser = new Fallout4VRCplParser(ctsTokens, "");
		...
		{
			Fallout4VRCplLexer lexLexer = new Fallout4VRCplLexer(new ANTLRStringStream(p_strCode));
