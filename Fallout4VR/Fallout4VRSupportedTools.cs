...
namespace Nexus.Client.Games.Fallout4VR
{
	...
	/// Launches Fallout4.
	/// </summary>
	public class Fallout4VRSupportedTools : SupportedToolsLauncherBase
	{
		#region Constructors
		...
		/// </summary>
		public Fallout4VRSupportedTools(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
