...
using Nexus.Client.Games.Fallout4VR.Tools.AI;
using Nexus.Client.Games.Fallout4VR.Tools.AI.UI;
using Nexus.Client.Games.Tools;

namespace Nexus.Client.Games.Fallout4VR.Tools
{
	/// <summary>
	/// Exposes the tools for Fallout4.
	/// </summary>
	public class Fallout4VRToolLauncher : IToolLauncher
	{
		...
		public Fallout4VRToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
		...
		protected void SetupTools()
		{
			...
			ArchiveInvalidation aitAI = new ArchiveInvalidation((Fallout4VRGameMode)GameMode);
