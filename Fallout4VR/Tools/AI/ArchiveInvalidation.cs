...
namespace Nexus.Client.Games.Fallout4VR.Tools.AI
{
	/// <summary>
	...
	public class ArchiveInvalidation : ITool
	{
		...
		protected Fallout4VRGameMode GameMode { get; private set; }
		...
		public ArchiveInvalidation(Fallout4VRGameMode p_gmdGameMode)
		{
