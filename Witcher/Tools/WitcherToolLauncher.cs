...
namespace Nexus.Client.Games.Witcher.Tools
{
    public class WitcherToolLauncher : IToolLauncher
    {
        ...
        public WitcherToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
