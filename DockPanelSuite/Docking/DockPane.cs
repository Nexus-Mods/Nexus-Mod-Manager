...
namespace WeifenLuo.WinFormsUI.Docking
{
	...
	public partial class DockPane : UserControl, IDockDragSource
	{
		...
		public void DockTo(DockPanel panel, DockStyle dockStyle)
		{
			...
			bool booIsAutoHidden = DockHelper.IsDockStateAutoHide(DockState);
			if (dockStyle == DockStyle.Top)
				DockState = booIsAutoHidden ? DockState.DockTopAutoHide : DockState.DockTop;
			else if (dockStyle == DockStyle.Bottom)
				DockState = booIsAutoHidden ? DockState.DockBottomAutoHide : DockState.DockBottom;
			else if (dockStyle == DockStyle.Left)
				DockState = booIsAutoHidden ? DockState.DockLeftAutoHide : DockState.DockLeft;
			else if (dockStyle == DockStyle.Right)
				DockState = booIsAutoHidden ? DockState.DockRightAutoHide : DockState.DockRight;
