...
{
    /// <summary>
    /// Provides the function context to use when executing StateOfDecay Mod Script scripts.
    /// </summary>
    public class StateOfDecayModScriptInterpreterContext : ModScriptInterpreterContext
    {
        #region Constructors
