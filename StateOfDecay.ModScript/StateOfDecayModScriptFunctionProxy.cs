...
namespace Nexus.Client.Games.StateOfDecay.Scripting.ModScript
{
    ...
    public class StateOfDecayModScriptFunctionProxy : ModScriptFunctionProxy
    {
		...
		public StateOfDecayModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
