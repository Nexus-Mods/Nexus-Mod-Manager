...
{
    /// <summary>
	/// Describes the StateOfDecay variant of the Mod Script type.
    /// </summary>
	public class StateOfDecayModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
			return new StateOfDecayModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
