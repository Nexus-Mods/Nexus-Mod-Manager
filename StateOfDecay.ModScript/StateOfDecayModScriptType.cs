...
namespace Nexus.Client.Games.StateOfDecay.Scripting.ModScript
{
	...
	public class StateOfDecayModScriptType : ModScriptType
    {
        ...
        {
			return new StateOfDecayModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
