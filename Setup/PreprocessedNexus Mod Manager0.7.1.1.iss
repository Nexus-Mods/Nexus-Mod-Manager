...
AppVersion=0.63.18
AppVerName=Nexus Mod Manager 0.63.18
AppCopyright=Copyright ï¿½ Black Tree Gaming 2011-2018
VersionInfoVersion=0.63.18
VersionInfoCompany=Black Tree Gaming
AppPublisher=Black Tree Gaming
;AppPublisherURL=http://...
;AppSupportURL=http://...
;AppUpdatesURL=http://...
OutputBaseFilename=Nexus Mod Manager-0.63.18
...
Name: associateNxmFiles; Description: &Associate *.NXM files with Nexus Mod Manager; GroupDescription: Other tasks:;
Name: associateNxmUrls; Description: Associate NXM: &URLs with Nexus Mod Manager; GroupDescription: Other tasks:;
Name: associateFomodFiles; Description: &Associate *.FOMOD files with Nexus Mod Manager; GroupDescription: Other tasks:;
Name: associateOmodFiles; Description: &Associate *.OMOD files with Nexus Mod Manager; GroupDescription: Other tasks:;
...
[Icons]
Name: {group}\Nexus Mod Manager; Filename: {app}\NexusClient.exe; WorkingDir: {app}
Name: {group}\Nexus Mod Manager (Trace Mode); Filename: {app}\NexusClient.exe; Parameters: -trace; WorkingDir: {app}
Name: {group}\{cm:UninstallProgram,Nexus Mod Manager}; Filename: {uninstallexe}; WorkingDir: {app}
Name: {commondesktop}\Nexus Mod Manager; Filename: {app}\NexusClient.exe; Tasks: desktopicon; WorkingDir: {app}
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\Nexus Mod Manager; Filename: {app}\NexusClient.exe; Tasks: quicklaunchicon; WorkingDir: {app}

[Run]
Filename: {app}\NexusClient.exe; Description: {cm:LaunchProgram,Nexus Mod Manager}; Flags: nowait postinstall skipifsilent

[Registry]
;.nxm
Root: HKCR; Subkey: .nxm; ValueType: string; ValueName: ; ValueData: NXM_File_Type; Flags: uninsdeletekey; Tasks: associateNxmFiles
Root: HKCR; Subkey: NXM_File_Type; ValueType: string; ValueName: ; ValueData: Nexus Mod Manager Mod Archive; Flags: uninsdeletekey; Tasks: associateNxmFiles
