...
{
    /// <summary>
	/// Describes the DarkSouls2 variant of the Mod Script type.
    /// </summary>
	public class DarkSouls2ModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
			return new DarkSouls2ModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
