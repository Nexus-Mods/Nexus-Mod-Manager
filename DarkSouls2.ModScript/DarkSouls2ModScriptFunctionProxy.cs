...
{
    /// <summary>
    /// Implements the functions availabe to the DarkSouls2 variant of Mod Script scripts.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class DarkSouls2ModScriptFunctionProxy : ModScriptFunctionProxy
    {
        #region Constructors
		...
		public DarkSouls2ModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
		...
		public bool DarkSouls2NewerThan(string p_strGameVersion)
        {
        ...
        {
			return ((DarkSouls2GameMode)GameMode).ScriptExtenderVersion;
        }
