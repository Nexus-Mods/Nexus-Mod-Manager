...
namespace Nexus.Client.Games.DarkSouls2.Scripting.ModScript
{
    ...
    public class DarkSouls2ModScriptFunctionProxy : ModScriptFunctionProxy
    {
		...
		public DarkSouls2ModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
