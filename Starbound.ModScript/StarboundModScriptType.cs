...
{
    /// <summary>
    /// Describes the Starbound variant of the Mod Script type.
    /// </summary>
    public class StarboundModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
            return new StarboundModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
