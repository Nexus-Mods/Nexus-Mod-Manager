...
namespace Nexus.Client.Games.Starbound.Scripting.ModScript
{
    ...
    public class StarboundModScriptType : ModScriptType
    {
        ...
        {
            return new StarboundModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
