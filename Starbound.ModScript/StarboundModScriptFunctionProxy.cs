...
{
    /// <summary>
    /// Implements the functions availabe to the Starbound variant of Mod Script scripts.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class StarboundModScriptFunctionProxy : ModScriptFunctionProxy
    {
        #region Constructors
		...
		public StarboundModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
        ...
        public bool StarboundNewerThan(string p_strGameVersion)
        {
        ...
        {
            return ((StarboundGameMode)GameMode).ScriptExtenderVersion;
        }
