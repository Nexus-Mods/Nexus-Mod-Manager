...
namespace Nexus.Client.Games.Starbound.Scripting.ModScript
{
    ...
    public class StarboundModScriptFunctionProxy : ModScriptFunctionProxy
    {
        ...
        public StarboundModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
