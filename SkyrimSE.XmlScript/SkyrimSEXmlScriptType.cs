...
using Nexus.Client.Games.SkyrimSE.Scripting.XmlScript.CPL;
using Nexus.Client.Games.SkyrimSE.Scripting.XmlScript.Parsers;
using Nexus.Client.Games.SkyrimSE.Scripting.XmlScript.Unparsers;
...
{
	/// <summary>
	/// Describes the SkyrimSE variant of the XML script type.
	/// </summary>
	public class SkyrimSEXmlScriptType : XmlScriptType
	{
		#region Properties
		...
		protected override string GameSpecificXMLScriptSchemaPath
		{
			get
			{
				return "Nexus/Client/Games/SkyrimSE/Scripting/XmlScript/data";
			}
		}
		...
		protected override IParser GetParser(XElement p_xelScript)
		{
			...
			switch (strScriptVersion)
			{
				...
				case "5.0":
					return new SkyrimSEParser50(p_xelScript, this);
			}
		...
		protected override IUnparser GetUnparser(Nexus.Client.ModManagement.Scripting.XmlScript.XmlScript p_xscScript)
		{
			switch (p_xscScript.Version.ToString())
			{
				...
				case "5.0":
					return new SkyrimSEUnparser50(p_xscScript);
		...
		{
			return new SkyrimSECplParserFactory();
		}
