...
namespace Nexus.Client.Games.SkyrimSE.Scripting.XmlScript.CPL.Controls
{
	/// <summary>
	/// The highlighting strategy for the SkyrimSE variant of the Conditional Pattern Language.
	/// </summary>
	/// <remarks>
	/// This is used to highilight CPL in the editor.
	/// </remarks>
	public class SkyrimSECplHighlightingStrategy : CplHighlightingStrategy
	{
		#region Constructors
		...
		public SkyrimSECplHighlightingStrategy(ICplParserFactory p_cpfLexerFactory)
		...
		protected override TokenClass GetTokenClass(int p_intTokenType)
		{
			...
			{
				case SkyrimSECplLexer.NVSE_VERSION:
