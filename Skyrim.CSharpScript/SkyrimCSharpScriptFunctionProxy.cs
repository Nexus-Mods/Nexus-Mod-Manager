...
namespace Nexus.Client.Games.Skyrim.Scripting.CSharpScript
{
	...
	public class SkyrimCSharpScriptFunctionProxy : FalloutCSharpScriptFunctionProxy
	{
		...
		public SkyrimCSharpScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, BsaManager p_bamBsaManager, UIUtil p_uipUIProxy)
