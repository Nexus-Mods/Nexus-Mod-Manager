...
namespace Nexus.Client.Games.DarkSouls.Scripting.ModScript
{
	...
	public class DarkSoulsModScriptType : ModScriptType
    {
        ...
        {
			return new DarkSoulsModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
