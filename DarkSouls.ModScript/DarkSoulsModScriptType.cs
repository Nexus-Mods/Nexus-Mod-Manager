...
{
    /// <summary>
	/// Describes the DarkSouls variant of the Mod Script type.
    /// </summary>
	public class DarkSoulsModScriptType : ModScriptType
    {
        /// <summary>
        ...
        {
			return new DarkSoulsModScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, new ModScriptUIUtil(p_gmdGameMode, p_eifEnvironmentInfo, p_scxUIContext));
        }
    }
}
