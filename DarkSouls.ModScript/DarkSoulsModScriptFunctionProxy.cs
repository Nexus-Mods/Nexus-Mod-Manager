...
{
    /// <summary>
    /// Implements the functions availabe to the DarkSouls variant of Mod Script scripts.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class DarkSoulsModScriptFunctionProxy : ModScriptFunctionProxy
    {
        #region Constructors
		...
		public DarkSoulsModScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, ModScriptUIUtil p_uipUIProxy)
		...
		public bool DarkSoulsNewerThan(string p_strGameVersion)
        {
        ...
        {
			return ((DarkSoulsGameMode)GameMode).ScriptExtenderVersion;
        }
