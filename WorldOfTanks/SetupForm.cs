...
{
	/// <summary>
    /// This is the setup form for the WorldOfTanks game mode.
	/// </summary>
	public partial class SetupForm : Form, IView
	{
		private WoTSetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
				m_vmlViewModel = value as WoTSetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a WoTSetupVM. Type found: " + value.GetType().FullName);
		...
		public SetupForm(WoTSetupVM p_vmlViewModel)
			: this()
		{
