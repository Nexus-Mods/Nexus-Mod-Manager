...
using Nexus.Client.Games.Sims4.Settings;
using Nexus.Client.Games.Sims4.Settings.UI;
using Nexus.Client.Games.Sims4.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage Sims4 game's plugins and mods.
	/// </summary>
	public class Sims4GameMode : GameModeBase
	{
		...
		/// <summary>
		/// Gets the path to the per user Sims4 data.
		/// </summary>
		/// <value>The path to the per user Sims4 data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new Sims4Launcher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new Sims4ToolLauncher(this, EnvironmentInfo);
		...
		public Sims4GameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
