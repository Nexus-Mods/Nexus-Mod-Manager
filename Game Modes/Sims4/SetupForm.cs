...
{
	/// <summary>
	/// This is the setup form for the Sims4 game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
		private Sims4SetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
				m_vmlViewModel = value as Sims4SetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a Sims4SetupVM. Type found: " + value.GetType().FullName);
