...
namespace Nexus.Client.Games.Sims4.Tools
{
    /// <summary>
	/// Exposes the tools for Sims4.
    /// </summary>
    public class Sims4ToolLauncher : IToolLauncher
    {
		...
		public Sims4ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
