...
namespace Nexus.Client.Games.Cyberpunk2077.Tools
{
	/// <summary>
	/// Exposes the tools for Cyberpunk2077.
	/// </summary>
	public class Cyberpunk2077ToolLauncher : IToolLauncher
	{
		...
		public Cyberpunk2077ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
