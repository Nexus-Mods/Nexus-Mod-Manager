...
{
	/// <summary>
	/// This is the setup form for the Cyberpunk2077 game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private Cyberpunk2077SetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as Cyberpunk2077SetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a Cyberpunk2077SetupVM. Type found: " + value.GetType().FullName);
