...
using Nexus.Client.Games.MonsterHunterWorld.Settings.UI;
using Nexus.Client.Games.MonsterHunterWorld.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage MonsterHunterWorld game's plugins and mods.
	/// </summary>
	public class MonsterHunterWorldGameMode : GameModeBase
	{
		private MonsterHunterWorldGameModeDescriptor m_gmdGameModeInfo = null;
		private MonsterHunterWorldLauncher m_glnGameLauncher = null;
		private MonsterHunterWorldToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per user MonsterHunterWorld data.
		/// </summary>
		/// <value>The path to the per user MonsterHunterWorld data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new MonsterHunterWorldLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new MonsterHunterWorldToolLauncher(this, EnvironmentInfo);
		...
		public MonsterHunterWorldGameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new MonsterHunterWorldGameModeDescriptor(EnvironmentInfo);
