...
namespace Nexus.Client.Games.MonsterHunterWorld
{
	...
	/// factories that build game modes for MonsterHunterWorld based games.
	/// </summary>
	public class MonsterHunterWorldGameModeFactory : IGameModeFactory
	{
...
/// <value>The descriptor of the game mode that this factory builds.</value>
		...
		public MonsterHunterWorldGameModeFactory(IEnvironmentInfo p_eifEnvironmentInfo)
		{
			EnvironmentInfo = p_eifEnvironmentInfo;
			m_gmdGameModeDescriptor = new MonsterHunterWorldGameModeDescriptor(p_eifEnvironmentInfo);
		}
		...
		public IGameMode BuildGameMode(FileUtil p_futFileUtility, out ViewMessage p_imsWarning)
		{
			...
			MonsterHunterWorldGameMode gmdGameMode = InstantiateGameMode(p_futFileUtility);
			p_imsWarning = null;
		...
		protected MonsterHunterWorldGameMode InstantiateGameMode(FileUtil p_futFileUtility)
		{
			return new MonsterHunterWorldGameMode(EnvironmentInfo, p_futFileUtility);
		}
		...
		public bool PerformInitialSetup(ShowViewDelegate p_dlgShowView, ShowMessageDelegate p_dlgShowMessage)
		{
			...
			MonsterHunterWorldSetupVM vmlSetup = new MonsterHunterWorldSetupVM(EnvironmentInfo, GameModeDescriptor);
