...
namespace Nexus.Client.Games.MonsterHunterWorld.Tools
{
	/// <summary>
	/// Exposes the tools for MonsterHunterWorld.
	/// </summary>
	public class MonsterHunterWorldToolLauncher : IToolLauncher
	{
		...
		public MonsterHunterWorldToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
