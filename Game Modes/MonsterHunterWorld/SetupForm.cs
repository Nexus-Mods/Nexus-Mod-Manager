...
{
	/// <summary>
	/// This is the setup form for the MonsterHunterWorld game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private MonsterHunterWorldSetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as MonsterHunterWorldSetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a MonsterHunterWorldSetupVM. Type found: " + value.GetType().FullName);
