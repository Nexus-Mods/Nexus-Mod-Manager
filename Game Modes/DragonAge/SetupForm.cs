...
{
	/// <summary>
    /// This is the setup form for the Dragon Age game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private DragonAgeSetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as DragonAgeSetupVM;
				if (m_vmlViewModel == null)
                    throw new ArgumentException("The given view model must be a DragonAgeSetupVM. Type found: " + value.GetType().FullName);
