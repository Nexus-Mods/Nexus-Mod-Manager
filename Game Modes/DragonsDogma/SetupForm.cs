...
{
	/// <summary>
	/// This is the setup form for the DragonsDogma game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private DragonsDogmaSetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as DragonsDogmaSetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a DragonsDogmaSetupVM. Type found: " + value.GetType().FullName);
        ...
        public SetupForm(DragonsDogmaSetupVM p_vmlViewModel)
			: this()
		{
