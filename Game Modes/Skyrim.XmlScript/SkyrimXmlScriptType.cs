...
{
	/// <summary>
	/// Describes the Skyrim variant of the XML script type.
	/// </summary>
	public class SkyrimXmlScriptType : XmlScriptType
	{
		#region Properties
		...
		protected override string GameSpecificXMLScriptSchemaPath
		{
			get
			{
				return "Nexus/Client/Games/Skyrim/Scripting/XmlScript/data";
			}
		}
		...
		protected override IParser GetParser(XElement p_xelScript)
		{
			...
			switch (strScriptVersion)
			{
				...
				case "5.0":
					return new SkyrimParser50(p_xelScript, this);
			}
		...
		{
			return new SkyrimCplParserFactory();
		}
