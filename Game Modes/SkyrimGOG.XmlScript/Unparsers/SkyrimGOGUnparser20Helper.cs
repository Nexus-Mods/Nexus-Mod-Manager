...
{
	/// <summary>
	/// A helper class that encapsulates unparsing of SkyrimGOG specific XML Script features.
	/// </summary>
	/// <remarks>
	/// This class encapsulates functionality that is used by several unparsers, so as to prevent
	/// code duplication.
	/// </remarks>
	public static class SkyrimGOGUnparser20Helper
	{
		/// <summary>
		/// Unparses the given <see cref="ICondition"/>.
		/// </summary>
		/// <remarks>
		/// This method provides SkyrimGOG-specific unparsing of the condition. If the given condition
		/// is not SkyrimGOG-specific, nothing in done.
		/// </remarks>
