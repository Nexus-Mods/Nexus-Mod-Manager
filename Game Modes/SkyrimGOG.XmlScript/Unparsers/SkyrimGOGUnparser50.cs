...
namespace Nexus.Client.Games.SkyrimGOG.Scripting.XmlScript.Unparsers
{
	/// <summary>
	/// Unparses the SkyrimGOG variety of the version 5.0 XML scripts.
	/// </summary>
	public class SkyrimGOGUnparser50 : Unparser50
	{
		#region Constructors
		...
		public SkyrimGOGUnparser50(Nexus.Client.ModManagement.Scripting.XmlScript.XmlScript p_xscScript)
			: base(p_xscScript)
		{
		}
		...
		{
			return SkyrimGOGUnparser20Helper.UnparseCondition(p_cndCondition) ?? base.UnparseCondition(p_cndCondition);
		}
	}
}
