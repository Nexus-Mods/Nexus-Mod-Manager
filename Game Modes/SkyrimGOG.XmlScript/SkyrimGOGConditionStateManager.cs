...
namespace Nexus.Client.Games.SkyrimGOG.Scripting.XmlScript
{
	...
	/// </summary>
	public class SkyrimGOGConditionStateManager : ConditionStateManager
	{
		#region Constructors
		...
		public SkyrimGOGConditionStateManager(IMod p_modMod, IGameMode p_gmdGameMode, IPluginManager p_pmgPluginManager, IEnvironmentInfo p_eifEnvironmentInfo)
