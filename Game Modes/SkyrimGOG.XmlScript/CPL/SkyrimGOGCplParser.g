parser grammar SkyrimGOGCplParser;
...
@parser::members {
	...
	public SkyrimGOGCplParser(ITokenStream input, string dummy)
		: base(input, new RecognizerSharedState())
	{
		gCPLImportParser = new SkyrimGOGCplParser_CPLImportParser(input, state, this);
