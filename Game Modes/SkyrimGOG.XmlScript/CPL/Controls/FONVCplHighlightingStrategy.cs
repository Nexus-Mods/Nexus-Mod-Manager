...
namespace Nexus.Client.Games.SkyrimGOG.Scripting.XmlScript.CPL.Controls
{
	/// <summary>
	/// The highlighting strategy for the SkyrimGOG variant of the Conditional Pattern Language.
	/// </summary>
	/// <remarks>
	/// This is used to highilight CPL in the editor.
	/// </remarks>
	public class SkyrimGOGCplHighlightingStrategy : CplHighlightingStrategy
	{
		#region Constructors
		...
		public SkyrimGOGCplHighlightingStrategy(ICplParserFactory p_cpfLexerFactory)
		...
		protected override TokenClass GetTokenClass(int p_intTokenType)
		{
			...
			{
				case SkyrimGOGCplLexer.NVSE_VERSION:
