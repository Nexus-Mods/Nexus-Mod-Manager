...
{
	/// <summary>
	/// Implements the functions availabe to OblivionRemastered C# scripts.
	/// </summary>
	public class OblivionRemasteredCSharpScriptFunctionProxy : FalloutCSharpScriptFunctionProxy
	{
		#region Constructors
		...
		public OblivionRemasteredCSharpScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, BsaManager p_bamBsaManager, UIUtil p_uipUIProxy)
		...
		{
			return ((OblivionRemasteredGameMode)GameMode).ScriptExtenderVersion;
		}
