...
namespace Nexus.Client.Games.DarkSouls2.Tools
{
    /// <summary>
	/// Exposes the tools for DarkSouls.
    /// </summary>
    public class DarkSouls2ToolLauncher : IToolLauncher
    {
		...
		public DarkSouls2ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
