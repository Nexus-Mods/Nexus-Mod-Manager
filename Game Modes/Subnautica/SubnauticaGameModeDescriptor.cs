...
using Nexus.Client.Games.Subnautica;

namespace Nexus.Client.Games.Subnautica
{
	/// <summary>
	/// Provides common information about Subnautica based games.
	/// </summary>
	public class SubnauticaGameModeDescriptor : GameModeDescriptorBase
	{
		private static string[] EXECUTABLES = { @"Subnautica.exe" };
		private static readonly List<string> STOP_FOLDERS = new List<string>() { "QMods" };
		private const string MODE_ID = "Subnautica";

		#region Properties

		/// <summary>
		/// Gets the directory where Subnautica plugins are installed.
		/// </summary>
		/// <value>The directory where Subnautica plugins are installed.</value>
		...
		public override Theme ModeTheme
		{
			get
			{
				return new Theme(Properties.Resources.Subnautica_logo, Color.FromArgb(81, 152, 234), null);
			}
		}
		...
		public SubnauticaGameModeDescriptor(IEnvironmentInfo p_eifEnvironmentInfo)
