...
namespace Nexus.Client.Games.Subnautica.Tools
{
	/// <summary>
	/// Exposes the tools for Subnautica.
	/// </summary>
	public class SubnauticaToolLauncher : IToolLauncher
	{
		...
		public SubnauticaToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
