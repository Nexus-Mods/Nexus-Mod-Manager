...
using Nexus.Client.Games.Subnautica.Settings.UI;
using Nexus.Client.Games.Subnautica.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage Subnautica game's plugins and mods.
	/// </summary>
	public class SubnauticaGameMode : GameModeBase
	{
		private SubnauticaGameModeDescriptor m_gmdGameModeInfo = null;
		private SubnauticaLauncher m_glnGameLauncher = null;
		private SubnauticaToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per user Subnautica data.
		/// </summary>
		/// <value>The path to the per user Subnautica data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new SubnauticaLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new SubnauticaToolLauncher(this, EnvironmentInfo);
		...
		public SubnauticaGameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new SubnauticaGameModeDescriptor(EnvironmentInfo);
