...
{
	/// <summary>
	/// This is the setup form for the Subnautica game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private SubnauticaSetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as SubnauticaSetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a SubnauticaSetupVM. Type found: " + value.GetType().FullName);
