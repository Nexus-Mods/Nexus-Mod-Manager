...
{
	/// <summary>
    /// This is the setup form for the Dragon Age 2 game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private DragonAge2SetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as DragonAge2SetupVM;
				if (m_vmlViewModel == null)
                    throw new ArgumentException("The given view model must be a DragonAge2SetupVM. Type found: " + value.GetType().FullName);
