...
namespace Nexus.Client.Games.DragonAge2.Tools
{
    /// <summary>
    /// Exposes the tools for Dragon Age 2.
    /// </summary>
    public class DragonAge2ToolLauncher : IToolLauncher
    {
        ...
        public DragonAge2ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
