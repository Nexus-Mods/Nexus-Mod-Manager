...
namespace Nexus.Client.Games.Morrowind.Scripting.ModScript
{
    ...
    /// </summary>
    public class MorrowindModScriptInterpreterContext : ModScriptInterpreterContext
    {
        #region Constructors
        ...
        {
            Variables[p_strVariableName] = ((MorrowindModScriptFunctionProxy)FunctionProxy).ReadRendererInfo(p_strRendererValue);
        }
