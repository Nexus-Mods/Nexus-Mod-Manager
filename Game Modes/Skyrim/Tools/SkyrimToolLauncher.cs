...
using Nexus.Client.Games.Skyrim.Tools.AI.UI;
...
namespace Nexus.Client.Games.Skyrim.Tools
{
	...
	/// </summary>
	public class SkyrimToolLauncher : IToolLauncher
	{
		...
		public SkyrimToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
