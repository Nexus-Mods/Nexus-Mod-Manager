...
namespace Nexus.Client.Games.Skyrim
{
	...
	public class SkyrimSupportedTools : SupportedToolsLauncherBase
	{
		...
		public override void SetupCommands()
		{
			...
			{
				imgIcon = SafeExtractIcon(strCommand);
				AddLaunchCommand(new Command("TES5Edit", LanguageManager.Format("GameModes.Commands.Tool.LaunchName", "Launch {0}", "TES5Edit"), LanguageManager.Format("GameModes.Commands.Tool.LaunchDescription", "Launches {0}.", "TES5Edit"), imgIcon, LaunchTES5Edit, true));
			}
			else
			{
				imgIcon = null;
				AddLaunchCommand(new Command("Config#TES5Edit", LanguageManager.Format("GameModes.Commands.Tool.ConfigName", "Config {0}", "TES5Edit"), LanguageManager.Format("GameModes.Commands.Tool.ConfigDescription", "Configures {0}.", "TES5Edit"), imgIcon, ConfigTES5Edit, true));
			}
