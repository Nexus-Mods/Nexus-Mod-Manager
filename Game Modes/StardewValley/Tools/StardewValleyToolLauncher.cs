...
namespace Nexus.Client.Games.StardewValley.Tools
{
	/// <summary>
	/// Exposes the tools for StardewValley.
	/// </summary>
	public class StardewValleyToolLauncher : IToolLauncher
	{
		...
		public StardewValleyToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
