...
{
	/// <summary>
	/// This is the setup form for the StardewValley game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private StardewValleySetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as StardewValleySetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a StardewValleySetupVM. Type found: " + value.GetType().FullName);
