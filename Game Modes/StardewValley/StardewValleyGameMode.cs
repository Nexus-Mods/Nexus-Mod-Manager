...
using Nexus.Client.Games.StardewValley.Settings.UI;
using Nexus.Client.Games.StardewValley.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage StardewValley game's plugins and mods.
	/// </summary>
	public class StardewValleyGameMode : GameModeBase
	{
		private StardewValleyGameModeDescriptor m_gmdGameModeInfo = null;
		private StardewValleyLauncher m_glnGameLauncher = null;
		private StardewValleyToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per user StardewValley data.
		/// </summary>
		/// <value>The path to the per user StardewValley data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new StardewValleyLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new StardewValleyToolLauncher(this, EnvironmentInfo);
		...
		public StardewValleyGameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new StardewValleyGameModeDescriptor(EnvironmentInfo);
