...
{
	/// <summary>
	/// Implements the functions availabe to SkyrimSE C# scripts.
	/// </summary>
	public class SkyrimSECSharpScriptFunctionProxy : FalloutCSharpScriptFunctionProxy
	{
		#region Constructors
		...
		public SkyrimSECSharpScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, BsaManager p_bamBsaManager, UIUtil p_uipUIProxy)
		...
		{
			return ((SkyrimSEGameMode)GameMode).ScriptExtenderVersion;
		}
