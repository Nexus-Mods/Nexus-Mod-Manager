...
{
	/// <summary>
	/// Provides the basic information about the SkyrimGOG game mode.
	/// </summary>
	public class SkyrimGOGGameModeDescriptor : GamebryoGameModeDescriptorBase
	{
        ...
        private const string MODE_ID = "SkyrimGOG";
		...
		public override Theme ModeTheme
		{
			get
			{
				return new Theme(Properties.Resources.SkyrimGOG_logo,Color.FromArgb(50, 104, 158),null);
			}
		}
		...
		public SkyrimGOGGameModeDescriptor(IEnvironmentInfo p_eifEnvironmentInfo)
