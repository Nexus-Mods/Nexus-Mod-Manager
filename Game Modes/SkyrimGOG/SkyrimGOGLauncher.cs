...
namespace Nexus.Client.Games.SkyrimGOG
{
	...
	/// Launches SkyrimGOG.
	/// </summary>
	public class SkyrimGOGLauncher : GameLauncherBase
	{
		#region Constructors
		...
		public SkyrimGOGLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		...
		protected override void SetupCommands()
		{
			...
			AddLaunchCommand(new Command("PlainLaunch", LanguageManager.Format("GameModes.Commands.Game.LaunchName", "Launch {0}", "Skyrim SE"), LanguageManager.Format("GameModes.Commands.Game.PlainLaunchDescription", "Launches plain {0}.", "Skyrim SE"), imgIcon, LaunchSkyrimGOGPlain, true));
			...
			imgIcon = SafeExtractIcon(strCommand);
			AddLaunchCommand(new Command("CustomLaunch", LanguageManager.Format("GameModes.Commands.Game.CustomLaunchName", "Launch Custom {0}", "Skyrim SE"), LanguageManager.Format("GameModes.Commands.Game.CustomLaunchDescription", "Launches {0} with custom command.", "Skyrim SE"), imgIcon, LaunchSkyrimGOGCustom, true));
		...
		/// </summary>
		private void LaunchSkyrimGOGCustom()
		{
		...
		/// </summary>
		private void LaunchSkyrimGOGSKSE()
		{
		...
		/// </summary>
		private void LaunchSkyrimGOGPlain()
		{
