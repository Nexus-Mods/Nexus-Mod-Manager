...
namespace Nexus.Client.Games.SkyrimGOG
{
	...
	public class SkyrimGOGLauncher : GameLauncherBase
	{
		...
		protected override void SetupCommands()
		{
			...
			AddLaunchCommand(new Command("PlainLaunch", "Launch Skyrim SE", "Launches plain Skyrim SE.", imgIcon, LaunchSkyrimGOGPlain, true));
			...
			if (File.Exists(strCommand))
			{
				...
				AddLaunchCommand(new Command("SkseLaunch", "Launch SKSE", "Launches Skyrim SE with SKSE.", imgIcon, LaunchSkyrimGOGSKSE, true));
			}
			
			strCommand = GetCustomLaunchCommand();
			Trace.TraceInformation("Custom Command: {0} (IsNull={1})", strCommand, (strCommand == null));
			imgIcon = File.Exists(strCommand) ? Icon.ExtractAssociatedIcon(strCommand).ToBitmap() : null;
			AddLaunchCommand(new Command("CustomLaunch", "Launch Custom Skyrim SE", "Launches Skyrim SE with custom command.", imgIcon, LaunchSkyrimGOGCustom, true));

			DefaultLaunchCommand = new Command("Launch SkyrimSE", "Launches SkyrimSE.", LaunchGame);
