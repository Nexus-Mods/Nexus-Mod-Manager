...
using Nexus.Client.Games.SkyrimGOG.Tools.AI;
using Nexus.Client.Games.SkyrimGOG.Tools.AI.UI;
using Nexus.Client.Games.Tools;

namespace Nexus.Client.Games.SkyrimGOG.Tools
{
	/// <summary>
	/// Exposes the tools for SkyrimGOG.
	/// </summary>
	public class SkyrimGOGToolLauncher : IToolLauncher
	{
		...
		public SkyrimGOGToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
		...
		protected void SetupTools()
		{
			...
			ArchiveInvalidation aitAI = new ArchiveInvalidation((SkyrimGOGGameMode)GameMode);
