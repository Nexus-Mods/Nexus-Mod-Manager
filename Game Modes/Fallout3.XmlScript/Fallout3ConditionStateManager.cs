...
namespace Nexus.Client.Games.Fallout3.Scripting.XmlScript
{
	...
	/// </summary>
	public class Fallout3ConditionStateManager : ConditionStateManager
	{
		#region Constructors
		...
		public Fallout3ConditionStateManager(IMod p_modMod, IGameMode p_gmdGameMode, IPluginManager p_pmgPluginManager, IEnvironmentInfo p_eifEnvironmentInfo)
