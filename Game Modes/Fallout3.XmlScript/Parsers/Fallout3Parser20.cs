...
{
	/// <summary>
	/// Provides Fallout 3 specific parsing for version 2.0 xml script files.
	/// </summary>
	public class Fallout3Parser20 : Parser20
	{
		#region Constructors
		...
		public Fallout3Parser20(XElement p_xelScript, XmlScriptType p_xstXmlScriptType)
