...
{
	/// <summary>
	/// Provides Fallout 3 specific parsing for version 1.0 xml script files.
	/// </summary>
	public class Fallout3Parser10 : Parser10
	{
		#region Constructors
		...
		public Fallout3Parser10(XElement p_xelScript, XmlScriptType p_xstXmlScriptType)
