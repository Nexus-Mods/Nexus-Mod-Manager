parser grammar Fallout4CplParser;
...
@parser::members {
	...
	public Fallout4CplParser(ITokenStream input, string dummy)
		: base(input, new RecognizerSharedState())
	{
		gCPLImportParser = new Fallout4CplParser_CPLImportParser(input, state, this);
