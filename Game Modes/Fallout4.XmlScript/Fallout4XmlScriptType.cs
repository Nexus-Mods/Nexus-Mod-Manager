...
using Nexus.Client.Games.Fallout4.Scripting.XmlScript.CPL;
using Nexus.Client.Games.Fallout4.Scripting.XmlScript.Parsers;
using Nexus.Client.Games.Fallout4.Scripting.XmlScript.Unparsers;
...
namespace Nexus.Client.Games.Fallout4.Scripting.XmlScript
{
	/// <summary>
	/// Describes the Fallout4 variant of the XML script type.
	/// </summary>
	public class Fallout4XmlScriptType : XmlScriptType
	{
		#region Properties
		...
		protected override IParser GetParser(XElement p_xelScript)
		{
			...
			switch (strScriptVersion)
			{
				...
				case "5.0":
					return new Fallout4Parser50(p_xelScript, this);
			}
		...
		protected override IUnparser GetUnparser(Nexus.Client.ModManagement.Scripting.XmlScript.XmlScript p_xscScript)
		{
			switch (p_xscScript.Version.ToString())
			{
				...
				case "5.0":
					return new Fallout4Unparser50(p_xscScript);
		...
		{
			return new Fallout4CplParserFactory();
		}
		...
		{
			return new Fallout4ConditionStateManager(p_modMod, p_gmdGameMode, p_pmgPluginManager, p_eifEnvironmentInfo);
		}
	}
}
