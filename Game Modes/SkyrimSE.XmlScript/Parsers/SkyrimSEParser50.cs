...
namespace Nexus.Client.Games.SkyrimSE.Scripting.XmlScript.Parsers
{
	/// <summary>
	/// Provides SkyrimSE specific parsing for version 5.0 xml script files.
	/// </summary>
	public class SkyrimSEParser50 : Parser50
	{
		#region Constructors
		...
		public SkyrimSEParser50(XElement p_xelScript, XmlScriptType p_xstXmlScriptType)
		...
		{
			return SkyrimSEParser20Helper.ParseCondition(p_xelCondition) ?? base.LoadCondition(p_xelCondition);
		}
	}
}
