...
namespace Nexus.Client.Games.SkyrimSE.Scripting.XmlScript.Unparsers
{
	/// <summary>
	/// A helper class that encapsulates unparsing of SkyrimSE specific XML Script features.
	/// </summary>
	/// <remarks>
	/// This class encapsulates functionality that is used by several unparsers, so as to prevent
	/// code duplication.
	/// </remarks>
	public static class SkyrimSEUnparser20Helper
	{
		/// <summary>
		/// Unparses the given <see cref="ICondition"/>.
		/// </summary>
		/// <remarks>
		/// This method provides SkyrimSE-specific unparsing of the condition. If the given condition
		/// is not SkyrimSE-specific, nothing in done.
		/// </remarks>
