...
{
	/// <summary>
	/// Unparses the SkyrimSE variety of the version 5.0 XML scripts.
	/// </summary>
	public class SkyrimSEUnparser50 : Unparser50
	{
		#region Constructors
		...
		{
			return SkyrimSEUnparser20Helper.UnparseCondition(p_cndCondition) ?? base.UnparseCondition(p_cndCondition);
		}
	}
}
