...
{
	/// <summary>
	/// The game mode factory that builds <see cref="EnderalGameMode"/>s.
	/// </summary>
	public class EnderalGameModeFactory : GamebryoGameModeFactory
	{
		...
		public EnderalGameModeFactory(IEnvironmentInfo p_eifEnvironmentInfo)
			: base(p_eifEnvironmentInfo)
		{
			m_gmdGameModeDescriptor = new EnderalGameModeDescriptor(p_eifEnvironmentInfo);
		}
		...
		{
			return new EnderalGameMode(EnvironmentInfo, p_futFileUtility);
		}
