...
using Nexus.Client.Games.Enderal.Tools.AI;
using Nexus.Client.Games.Enderal.Tools.AI.UI;
using Nexus.Client.Games.Tools;

namespace Nexus.Client.Games.Enderal.Tools
{
	/// <summary>
	/// Exposes the tools for Enderal.
	/// </summary>
	public class EnderalToolLauncher : IToolLauncher
	{
		...
		public EnderalToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
		...
		protected void SetupTools()
		{
			...
			ArchiveInvalidation aitAI = new ArchiveInvalidation((EnderalGameMode)GameMode);
