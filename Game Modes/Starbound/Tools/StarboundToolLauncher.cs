...
namespace Nexus.Client.Games.Starbound.Tools
{
    /// <summary>
    /// Exposes the tools for Starbound.
    /// </summary>
    public class StarboundToolLauncher : IToolLauncher
    {
		...
		public StarboundToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
