...
using Nexus.Client.Games.HogwartsLegacy.Settings.UI;
using Nexus.Client.Games.HogwartsLegacy.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage HogwartsLegacy game's plugins and mods.
	/// </summary>
	public class HogwartsLegacyGameMode : GameModeBase
	{
		private HogwartsLegacyGameModeDescriptor m_gmdGameModeInfo = null;
		private HogwartsLegacyLauncher m_glnGameLauncher = null;
		private HogwartsLegacyToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per user HogwartsLegacy data.
		/// </summary>
		/// <value>The path to the per user HogwartsLegacy data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new HogwartsLegacyLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new HogwartsLegacyToolLauncher(this, EnvironmentInfo);
		...
		public HogwartsLegacyGameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new HogwartsLegacyGameModeDescriptor(EnvironmentInfo);
