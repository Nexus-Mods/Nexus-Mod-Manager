...
namespace Nexus.Client.Games.HogwartsLegacy.Tools
{
	/// <summary>
	/// Exposes the tools for HogwartsLegacy.
	/// </summary>
	public class HogwartsLegacyToolLauncher : IToolLauncher
	{
		...
		public HogwartsLegacyToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
