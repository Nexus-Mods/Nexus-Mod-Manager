...
{
	/// <summary>
	/// This is the setup form for the HogwartsLegacy game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private HogwartsLegacySetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as HogwartsLegacySetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a HogwartsLegacySetupVM. Type found: " + value.GetType().FullName);
        ...
        public SetupForm(HogwartsLegacySetupVM p_vmlViewModel)
			: this()
		{
