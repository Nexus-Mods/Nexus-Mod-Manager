...
namespace Nexus.Client.Games.Fallout4.Scripting.CSharpScript
{
	...
	/// </summary>
	public class Fallout4CSharpScriptType : CSharpScriptType
	{
		#region Properties
		...
		protected override Type BaseScriptType
		{
			get
			{
				return typeof(Fallout4CSharpBaseScript);
			}
		}
		...
		protected override CSharpScriptFunctionProxy GetScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, SynchronizationContext p_scxUIContext)
		{
			...
			return new Fallout4CSharpScriptFunctionProxy(p_modMod, p_gmdGameMode, p_eifEnvironmentInfo, p_ivaVirtualModActivator, p_igpInstallers, bmgBsaManager, uitUiUtilities);
		}
	}
}
