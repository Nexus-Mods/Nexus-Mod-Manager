...
namespace Nexus.Client.Games.FalloutNV.Scripting.XmlScript
{
	...
	/// </summary>
	public class FalloutNVConditionStateManager : ConditionStateManager
	{
		#region Constructors
		...
		public FalloutNVConditionStateManager(IMod p_modMod, IGameMode p_gmdGameMode, IPluginManager p_pmgPluginManager, IEnvironmentInfo p_eifEnvironmentInfo)
