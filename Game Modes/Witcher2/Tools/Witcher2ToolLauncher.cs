...
namespace Nexus.Client.Games.Witcher2.Tools
{
    /// <summary>
	/// Exposes the tools for The Witcher 2.
    /// </summary>
    public class Witcher2ToolLauncher : IToolLauncher
    {
        ...
        public Witcher2ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
