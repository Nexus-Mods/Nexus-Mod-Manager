...
using Nexus.Client.Games.Witcher2.Settings;
using Nexus.Client.Games.Witcher2.Settings.UI;
using Nexus.Client.Games.Witcher2.Tools;
...
namespace Nexus.Client.Games.Witcher2
{
	...
	public class Witcher2GameMode : GameModeBase
	{
		...
		public Witcher2GameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new Witcher2GameModeDescriptor(EnvironmentInfo);
