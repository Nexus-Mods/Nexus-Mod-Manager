...
{
	/// <summary>
	/// Implements the functions availabe to Starfield C# scripts.
	/// </summary>
	public class StarfieldCSharpScriptFunctionProxy : FalloutCSharpScriptFunctionProxy
	{
		#region Constructors
		...
		public StarfieldCSharpScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, BsaManager p_bamBsaManager, UIUtil p_uipUIProxy)
		...
		{
			return ((StarfieldGameMode)GameMode).ScriptExtenderVersion;
		}
