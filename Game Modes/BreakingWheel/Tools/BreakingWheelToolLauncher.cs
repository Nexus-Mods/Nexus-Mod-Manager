...
namespace Nexus.Client.Games.BreakingWheel.Tools
{
    /// <summary>
	/// Exposes the tools for BreakingWheel.
    /// </summary>
    public class BreakingWheelToolLauncher : IToolLauncher
    {
		...
		public BreakingWheelToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
