...
namespace Nexus.Client.Games.MountAndBlade2Bannerlord.Tools
{
	/// <summary>
	/// Exposes the tools for MountAndBlade2Bannerlord.
	/// </summary>
	public class MountAndBlade2BannerlordToolLauncher : IToolLauncher
	{
		...
		public MountAndBlade2BannerlordToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
