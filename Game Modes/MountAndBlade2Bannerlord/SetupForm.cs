...
{
	/// <summary>
	/// This is the setup form for the MountAndBlade2Bannerlord game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private MountAndBlade2BannerlordSetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as MountAndBlade2BannerlordSetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a MountAndBlade2BannerlordSetupVM. Type found: " + value.GetType().FullName);
