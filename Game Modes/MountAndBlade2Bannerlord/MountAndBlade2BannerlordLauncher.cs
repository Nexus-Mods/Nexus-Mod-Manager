...
{
	/// <summary>
	/// Launches MountAndBlade2Bannerlord.
	/// </summary>
	public class MountAndBlade2BannerlordLauncher : GameLauncherBase
	{
		#region Constructors
		...
		public MountAndBlade2BannerlordLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		...
		/// </summary>
		private void LaunchMountAndBlade2BannerlordCustom()
		{
			Trace.TraceInformation("Launching MountAndBlade2Bannerlord (Custom)...");
			Trace.Indent();
		...
		/// </summary>
		private void LaunchMountAndBlade2BannerlordPlain()
		{
			Trace.TraceInformation("Launching MountAndBlade2Bannerlord (Default)...");
			Trace.Indent();
			string strCommand = GetPlainLaunchCommand();
		...
		{
			string strCommand = Path.Combine(GameMode.ExecutablePath, "MountAndBlade2Bannerlord.exe");
			return strCommand;
		}
		...
		private void LaunchGame()
		{
			if (!string.IsNullOrEmpty(EnvironmentInfo.Settings.CustomLaunchCommands[GameMode.ModeId]))
				LaunchMountAndBlade2BannerlordCustom();
			else
				LaunchMountAndBlade2BannerlordPlain();
		}
