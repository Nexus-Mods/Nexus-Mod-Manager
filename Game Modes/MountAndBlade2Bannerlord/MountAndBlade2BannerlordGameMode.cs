...
using Nexus.Client.Games.MountAndBlade2Bannerlord.Settings.UI;
using Nexus.Client.Games.MountAndBlade2Bannerlord.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage MountAndBlade2Bannerlord game's plugins and mods.
	/// </summary>
	public class MountAndBlade2BannerlordGameMode : GameModeBase
	{
		private MountAndBlade2BannerlordGameModeDescriptor m_gmdGameModeInfo = null;
		private MountAndBlade2BannerlordLauncher m_glnGameLauncher = null;
		private MountAndBlade2BannerlordToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per user MountAndBlade2Bannerlord data.
		/// </summary>
		/// <value>The path to the per user MountAndBlade2Bannerlord data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new MountAndBlade2BannerlordLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new MountAndBlade2BannerlordToolLauncher(this, EnvironmentInfo);
		...
		public MountAndBlade2BannerlordGameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new MountAndBlade2BannerlordGameModeDescriptor(EnvironmentInfo);
