...
{
	/// <summary>
	/// The game mode factory that builds <see cref="EnderalSEGameMode"/>s.
	/// </summary>
	public class EnderalSEGameModeFactory : GamebryoGameModeFactory
	{
		...
		public EnderalSEGameModeFactory(IEnvironmentInfo p_eifEnvironmentInfo)
			: base(p_eifEnvironmentInfo)
		{
			m_gmdGameModeDescriptor = new EnderalSEGameModeDescriptor(p_eifEnvironmentInfo);
		}
		...
		{
			return new EnderalSEGameMode(EnvironmentInfo, p_futFileUtility);
		}
		...
		{
            string strValue = SteamInstallationPathDetector.Instance.GetSteamInstallationPath("933480", "Enderal Special Edition", "Enderal Launcher.exe");
