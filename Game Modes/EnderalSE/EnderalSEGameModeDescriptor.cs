...
{
	/// <summary>
	/// Provides the basic information about the EnderalSE game mode.
	/// </summary>
	public class EnderalSEGameModeDescriptor : GamebryoGameModeDescriptorBase
	{
        ...
        private const string MODE_ID = "enderalspecialedition";
		...
		public override Theme ModeTheme
		{
			get
			{
				return new Theme(Properties.Resources.EnderalSE_logo,Color.FromArgb(50, 104, 158),null);
			}
		}
		...
		public EnderalSEGameModeDescriptor(IEnvironmentInfo p_eifEnvironmentInfo)
