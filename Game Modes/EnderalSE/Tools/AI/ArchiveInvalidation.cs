namespace Nexus.Client.Games.EnderalSE.Tools.AI
{
    using System;
	...
	public class ArchiveInvalidation : ITool
	{
		...
		protected EnderalSEGameMode GameMode { get; private set; }
		...
		public ArchiveInvalidation(EnderalSEGameMode p_gmdGameMode)
		{
