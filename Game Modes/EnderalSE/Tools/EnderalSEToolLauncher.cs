...
using Nexus.Client.Games.EnderalSE.Tools.AI;
using Nexus.Client.Games.EnderalSE.Tools.AI.UI;
using Nexus.Client.Games.Tools;

namespace Nexus.Client.Games.EnderalSE.Tools
{
	/// <summary>
	/// Exposes the tools for EnderalSE.
	/// </summary>
	public class EnderalSEToolLauncher : IToolLauncher
	{
		...
		public EnderalSEToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
		...
		protected void SetupTools()
		{
			...
			ArchiveInvalidation aitAI = new ArchiveInvalidation((EnderalSEGameMode)GameMode);
