...
namespace Nexus.Client.Games.StateOfDecay
{
    ...
    {
        private StateOfDecaySetupVM m_vmlViewModel = null;
        ...
        public SetupBaseVM ViewModel
        {
            ...
            private set
            {
                m_vmlViewModel = value as StateOfDecaySetupVM;
                if (m_vmlViewModel == null)
                    throw new ArgumentException("The given view model must be a StateOfDecaySetupVM. Type found: " + value.GetType().FullName);
