...
namespace Nexus.Client.Games.StateOfDecay.Tools
{
    /// <summary>
    /// Exposes the tools for StateOfDecay.
    /// </summary>
    public class StateOfDecayToolLauncher : IToolLauncher
    {
        ...
        public StateOfDecayToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
