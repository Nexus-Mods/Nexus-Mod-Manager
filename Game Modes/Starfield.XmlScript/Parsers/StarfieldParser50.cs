...
namespace Nexus.Client.Games.Starfield.Scripting.XmlScript.Parsers
{
	/// <summary>
	/// Provides Starfield specific parsing for version 5.0 xml script files.
	/// </summary>
	public class StarfieldParser50 : Parser50
	{
		#region Constructors
		...
		public StarfieldParser50(XElement p_xelScript, XmlScriptType p_xstXmlScriptType)
		...
		{
			return StarfieldParser20Helper.ParseCondition(p_xelCondition) ?? base.LoadCondition(p_xelCondition);
		}
	}
}
