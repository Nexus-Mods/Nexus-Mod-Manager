...
namespace Nexus.Client.Games.Starfield.Scripting.XmlScript.Unparsers
{
	/// <summary>
	/// Unparses the Starfield variety of the version 5.0 XML scripts.
	/// </summary>
	public class StarfieldUnparser50 : Unparser50
	{
		#region Constructors
		...
		public StarfieldUnparser50(Nexus.Client.ModManagement.Scripting.XmlScript.XmlScript p_xscScript)
			: base(p_xscScript)
		{
		}
		...
		{
			return StarfieldUnparser20Helper.UnparseCondition(p_cndCondition) ?? base.UnparseCondition(p_cndCondition);
		}
	}
}
