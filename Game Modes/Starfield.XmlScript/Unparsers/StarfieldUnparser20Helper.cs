...
{
	/// <summary>
	/// A helper class that encapsulates unparsing of Starfield specific XML Script features.
	/// </summary>
	/// <remarks>
	/// This class encapsulates functionality that is used by several unparsers, so as to prevent
	/// code duplication.
	/// </remarks>
	public static class StarfieldUnparser20Helper
	{
		/// <summary>
		/// Unparses the given <see cref="ICondition"/>.
		/// </summary>
		/// <remarks>
		/// This method provides Starfield-specific unparsing of the condition. If the given condition
		/// is not Starfield-specific, nothing in done.
		/// </remarks>
