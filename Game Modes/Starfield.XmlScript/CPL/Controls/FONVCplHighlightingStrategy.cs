...
namespace Nexus.Client.Games.Starfield.Scripting.XmlScript.CPL.Controls
{
	/// <summary>
	/// The highlighting strategy for the Starfield variant of the Conditional Pattern Language.
	/// </summary>
	/// <remarks>
	/// This is used to highilight CPL in the editor.
	/// </remarks>
	public class StarfieldCplHighlightingStrategy : CplHighlightingStrategy
	{
		#region Constructors
		...
		public StarfieldCplHighlightingStrategy(ICplParserFactory p_cpfLexerFactory)
		...
		protected override TokenClass GetTokenClass(int p_intTokenType)
		{
			...
			{
				case StarfieldCplLexer.NVSE_VERSION:
