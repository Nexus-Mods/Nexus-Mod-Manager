...
{
	/// <summary>
	/// Creates CPL parsers for the Starfield variant of CPL.
	/// </summary>
	public class StarfieldCplParserFactory : ICplParserFactory
	{
		...
		public AntlrParserBase CreateParser(string p_strCode, ErrorTracker p_ertErrorTracker)
		{
			...
			StarfieldCplParser prsParser = new StarfieldCplParser(ctsTokens, "");
		...
		{
			StarfieldCplLexer lexLexer = new StarfieldCplLexer(new ANTLRStringStream(p_strCode));
