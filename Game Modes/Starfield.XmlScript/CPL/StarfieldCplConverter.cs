...
namespace Nexus.Client.Games.Starfield.Scripting.XmlScript.CPL
{
	/// <summary>
	/// A converter that translates CPL to and from an <see cref="ICondition"/>,
	/// </summary>
	public class StarfieldCplConverter : CPLConverter
	{
		/// <summary>
		...
		public StarfieldCplConverter(ICplParserFactory p_pftParserFactory)
		...
		protected override ICondition BuildCompositeCondition(ITree p_astCPL)
		{
			switch (p_astCPL.Type)
			{
				case CPLParser.ATLEAST:
					...
					{
						case StarfieldCplParser.SKSE_VERSION:
