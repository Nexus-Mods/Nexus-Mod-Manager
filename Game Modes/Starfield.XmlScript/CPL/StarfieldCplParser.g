parser grammar StarfieldCplParser;
...
@parser::members {
	...
	public StarfieldCplParser(ITokenStream input, string dummy)
		: base(input, new RecognizerSharedState())
	{
		gCPLImportParser = new StarfieldCplParser_CPLImportParser(input, state, this);
