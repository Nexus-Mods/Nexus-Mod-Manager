...
using Nexus.Client.Games.FalloutNV.Tools.AI;
using Nexus.Client.Games.Gamebryo.Tools.AI.UI;
using Nexus.Client.Games.Tools;

namespace Nexus.Client.Games.FalloutNV.Tools
{
	/// <summary>
	/// Exposes the tools for Fallout: New Vegas.
	/// </summary>
	public class FalloutNVToolLauncher : IToolLauncher
	{
		...
		public FalloutNVToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
		...
		protected void SetupTools()
		{
			...
			ArchiveInvalidation aitAI = new ArchiveInvalidation((FalloutNVGameMode)GameMode);
