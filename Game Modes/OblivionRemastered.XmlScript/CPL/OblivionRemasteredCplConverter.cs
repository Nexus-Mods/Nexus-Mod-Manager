...
namespace Nexus.Client.Games.OblivionRemastered.Scripting.XmlScript.CPL
{
	...
	/// </summary>
	public class OblivionRemasteredCplConverter : CPLConverter
	{
		/// <summary>
		...
		public OblivionRemasteredCplConverter(ICplParserFactory p_pftParserFactory)
		...
		protected override ICondition BuildCompositeCondition(ITree p_astCPL)
		{
			switch (p_astCPL.Type)
			{
				case CPLParser.ATLEAST:
					...
					{
						case OblivionRemasteredCplParser.SKSE_VERSION:
