parser grammar OblivionRemasteredCplParser;
...
options {
	...
	tokenVocab=OblivionRemasteredCplLexer;
}
...
@parser::members {
	...
	public OblivionRemasteredCplParser(ITokenStream input, string dummy)
		: base(input, new RecognizerSharedState())
	{
		gCPLImportParser = new OblivionRemasteredCplParser_CPLImportParser(input, state, this);
