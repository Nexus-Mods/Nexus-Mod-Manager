...
namespace Nexus.Client.Games.OblivionRemastered.Scripting.XmlScript.Unparsers
{
	/// <summary>
	/// Unparses the OblivionRemastered variety of the version 5.0 XML scripts.
	/// </summary>
	public class OblivionRemasteredUnparser50 : Unparser50
	{
		#region Constructors
		...
		public OblivionRemasteredUnparser50(Nexus.Client.ModManagement.Scripting.XmlScript.XmlScript p_xscScript)
			: base(p_xscScript)
		{
		}
		...
		{
			return OblivionRemasteredUnparser20Helper.UnparseCondition(p_cndCondition) ?? base.UnparseCondition(p_cndCondition);
		}
	}
}
