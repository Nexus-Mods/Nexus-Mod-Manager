...
namespace Nexus.Client.Games.OblivionRemastered.Scripting.XmlScript.Parsers
{
	/// <summary>
	/// Provides OblivionRemastered specific parsing for version 5.0 xml script files.
	/// </summary>
	public class OblivionRemasteredParser50 : Parser50
	{
		#region Constructors
		...
		public OblivionRemasteredParser50(XElement p_xelScript, XmlScriptType p_xstXmlScriptType)
		...
		{
			return OblivionRemasteredParser20Helper.ParseCondition(p_xelCondition) ?? base.LoadCondition(p_xelCondition);
		}
	}
}
