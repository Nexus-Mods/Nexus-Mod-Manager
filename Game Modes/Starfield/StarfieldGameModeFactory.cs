...
{
	/// <summary>
	/// The game mode factory that builds <see cref="StarfieldGameMode"/>s.
	/// </summary>
	public class StarfieldGameModeFactory : GamebryoGameModeFactory
	{
		...
		public StarfieldGameModeFactory(IEnvironmentInfo p_eifEnvironmentInfo)
			: base(p_eifEnvironmentInfo)
		{
			m_gmdGameModeDescriptor = new StarfieldGameModeDescriptor(p_eifEnvironmentInfo);
		}
		...
		{
			return new StarfieldGameMode(EnvironmentInfo, p_futFileUtility);
		}
		...
		{
            var strValue = SteamInstallationPathDetector.Instance.GetSteamInstallationPath("1716740", "Starfield", "Starfield.exe");
