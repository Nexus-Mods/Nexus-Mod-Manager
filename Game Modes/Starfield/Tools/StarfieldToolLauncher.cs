...
using Nexus.Client.Games.Starfield.Tools.AI;
using Nexus.Client.Games.Starfield.Tools.AI.UI;
using Nexus.Client.Games.Tools;

namespace Nexus.Client.Games.Starfield.Tools
{
	/// <summary>
	/// Exposes the tools for Starfield.
	/// </summary>
	public class StarfieldToolLauncher : IToolLauncher
	{
		...
		public StarfieldToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
		...
		protected void SetupTools()
		{
			...
			ArchiveInvalidation aitAI = new ArchiveInvalidation((StarfieldGameMode)GameMode);
