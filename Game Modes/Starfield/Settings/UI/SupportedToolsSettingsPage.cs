...
namespace Nexus.Client.Games.Starfield.Settings.UI
{
	...
	public partial class SupportedToolsSettingsPage : UserControl, ISettingsGroupView
	{
		...
		protected SupportedToolsSettingsPage()
		{
			...
			lblTES5EditPrompt.Text = LanguageManager.Format("GameModes.SupportedTools.SelectDirectoryPrompt", "Select the directory where {0} is installed:", "TES5Edit");
			...
			lblTES5EditLabel.Text = LanguageManager.Format("GameModes.SupportedTools.PathLabel", "{0} path:", "TES5Edit");
		}
