...
namespace Nexus.Client.Games.Starfield
{
	...
	/// Launches Starfield.
	/// </summary>
	public class StarfieldSupportedTools : SupportedToolsLauncherBase
	{
		#region Constructors
		...
		/// </summary>
		public StarfieldSupportedTools(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		...
		public override void SetupCommands()
		{
			...
			{
				imgIcon = SafeExtractIcon(strCommand);
				AddLaunchCommand(new Command("SFEdit", LanguageManager.Format("GameModes.Commands.Tool.LaunchName", "Launch {0}", "SFEdit"), LanguageManager.Format("GameModes.Commands.Tool.LaunchDescription", "Launches {0}.", "SFEdit"), imgIcon, LaunchSFEdit, true));
			}
			else
			{
				imgIcon = null;
				AddLaunchCommand(new Command("Config#SFEdit", LanguageManager.Format("GameModes.Commands.Tool.ConfigName", "Config {0}", "SFEdit"), LanguageManager.Format("GameModes.Commands.Tool.ConfigDescription", "Configures {0}.", "SFEdit"), imgIcon, ConfigSFEdit, true));
			}
