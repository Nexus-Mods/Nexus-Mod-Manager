...
{
	/// <summary>
	/// This is the setup form for the BaldursGate3 game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
		private BaldursGate3SetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
				m_vmlViewModel = value as BaldursGate3SetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a BaldursGate3SetupVM. Type found: " + value.GetType().FullName);
