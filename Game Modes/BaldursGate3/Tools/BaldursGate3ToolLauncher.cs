...
namespace Nexus.Client.Games.BaldursGate3.Tools
{
    /// <summary>
	/// Exposes the tools for BaldursGate3.
    /// </summary>
    public class BaldursGate3ToolLauncher : IToolLauncher
    {
		...
		public BaldursGate3ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
