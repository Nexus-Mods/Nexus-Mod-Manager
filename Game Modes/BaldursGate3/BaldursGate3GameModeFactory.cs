...
namespace Nexus.Client.Games.BaldursGate3
{
	...
	/// factories that build game modes for BaldursGate3 based games.
	/// </summary>
	public class BaldursGate3GameModeFactory : IGameModeFactory
	{
		...
		public BaldursGate3GameModeFactory(IEnvironmentInfo p_eifEnvironmentInfo)
		{
			EnvironmentInfo = p_eifEnvironmentInfo;
			m_gmdGameModeDescriptor = new BaldursGate3GameModeDescriptor(p_eifEnvironmentInfo);
		}
		...
		public IGameMode BuildGameMode(FileUtil p_futFileUtility, out ViewMessage p_imsWarning)
		{
			...
			BaldursGate3GameMode gmdGameMode = InstantiateGameMode(p_futFileUtility);
			p_imsWarning = null;
		...
		protected BaldursGate3GameMode InstantiateGameMode(FileUtil p_futFileUtility)
		{
			return new BaldursGate3GameMode(EnvironmentInfo, p_futFileUtility);
		}
		...
		public bool PerformInitialSetup(ShowViewDelegate p_dlgShowView, ShowMessageDelegate p_dlgShowMessage)
		{
			...
			BaldursGate3SetupVM vmlSetup = new BaldursGate3SetupVM(EnvironmentInfo, GameModeDescriptor);
