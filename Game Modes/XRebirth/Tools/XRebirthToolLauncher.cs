...
namespace Nexus.Client.Games.XRebirth.Tools
{
	/// <summary>
	/// Exposes the tools for XRebirth.
	/// </summary>
	public class XRebirthToolLauncher : IToolLauncher
	{
		...
		public XRebirthToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
