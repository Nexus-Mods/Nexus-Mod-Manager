...
{
	/// <summary>
	/// The game mode factory that builds <see cref="OblivionRemasteredGameMode"/>s.
	/// </summary>
	public class OblivionRemasteredGameModeFactory : GamebryoGameModeFactory
	{
		...
		public OblivionRemasteredGameModeFactory(IEnvironmentInfo p_eifEnvironmentInfo)
			: base(p_eifEnvironmentInfo)
		{
			m_gmdGameModeDescriptor = new OblivionRemasteredGameModeDescriptor(p_eifEnvironmentInfo);
		}
		...
		{
			return new OblivionRemasteredGameMode(EnvironmentInfo, p_futFileUtility);
		}
		...
		{
			var strValue = SteamInstallationPathDetector.Instance.GetSteamInstallationPath("2623190", "OblivionRemastered", "OblivionRemastered.exe");
