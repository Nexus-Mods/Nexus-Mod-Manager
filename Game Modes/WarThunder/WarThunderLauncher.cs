...
namespace Nexus.Client.Games.WarThunder
{
	...
	/// Launches WarThunder.
    /// </summary>
    public class WarThunderLauncher : GameLauncherBase
    {
        #region Constructors
		...
		public WarThunderLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        ...
        /// </summary>
		private void LaunchWarThunderCustom()
        {
			Trace.TraceInformation("Launching War Thunder (Custom)...");
            Trace.Indent();
        ...
        /// Launches the game.
        /// </summary>
		private void LaunchWarThunderPlain()
        {
			Trace.TraceInformation("Launching War Thunder (Launcher)...");
            Trace.Indent();
            string strCommand = GetPlainLaunchCommand();
        ...
        private void LaunchGame()
        {
            if (!String.IsNullOrEmpty(EnvironmentInfo.Settings.CustomLaunchCommands[GameMode.ModeId]))
				LaunchWarThunderCustom();
            else
				LaunchWarThunderPlain();
        }
