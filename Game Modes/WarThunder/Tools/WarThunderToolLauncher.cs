...
namespace Nexus.Client.Games.WarThunder.Tools
{
    /// <summary>
	/// Exposes the tools for WarThunder.
    /// </summary>
    public class WarThunderToolLauncher : IToolLauncher
    {
		...
		public WarThunderToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
