...
{
	/// <summary>
	/// Implements the functions availabe to SkyrimGOG C# scripts.
	/// </summary>
	public class SkyrimGOGCSharpScriptFunctionProxy : FalloutCSharpScriptFunctionProxy
	{
		#region Constructors
		...
		public SkyrimGOGCSharpScriptFunctionProxy(IMod p_modMod, IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo, IVirtualModActivator p_ivaVirtualModActivator, InstallerGroup p_igpInstallers, BsaManager p_bamBsaManager, UIUtil p_uipUIProxy)
		...
		{
			return ((SkyrimGOGGameMode)GameMode).ScriptExtenderVersion;
		}
