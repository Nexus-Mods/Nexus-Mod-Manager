...
using Nexus.Client.Games.DarkSouls.Settings;
using Nexus.Client.Games.DarkSouls.Settings.UI;
using Nexus.Client.Games.DarkSouls.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage DarkSouls game's plugins and mods.
	/// </summary>
	public class DarkSoulsGameMode : GameModeBase
	{
		private DarkSoulsGameModeDescriptor m_gmdGameModeInfo = null;
		private DarkSoulsLauncher m_glnGameLauncher = null;
		private DarkSoulsToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per user DarkSouls data.
		/// </summary>
		/// <value>The path to the per user DarkSouls data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new DarkSoulsLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new DarkSoulsToolLauncher(this, EnvironmentInfo);
		...
		public DarkSoulsGameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new DarkSoulsGameModeDescriptor(EnvironmentInfo);
