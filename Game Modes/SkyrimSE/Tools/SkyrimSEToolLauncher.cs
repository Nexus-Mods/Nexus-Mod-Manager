...
using Nexus.Client.Games.SkyrimSE.Tools.AI;
using Nexus.Client.Games.SkyrimSE.Tools.AI.UI;
using Nexus.Client.Games.Tools;

namespace Nexus.Client.Games.SkyrimSE.Tools
{
	/// <summary>
	/// Exposes the tools for SkyrimSE.
	/// </summary>
	public class SkyrimSEToolLauncher : IToolLauncher
	{
		...
		public SkyrimSEToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
		...
		protected void SetupTools()
		{
			...
			ArchiveInvalidation aitAI = new ArchiveInvalidation((SkyrimSEGameMode)GameMode);
