...
{
	/// <summary>
	/// This is the setup form for the Witcher3 game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private Witcher3SetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as Witcher3SetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a Witcher3SetupVM. Type found: " + value.GetType().FullName);
