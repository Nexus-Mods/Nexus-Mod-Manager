...
namespace Nexus.Client.Games.XCOM2.Tools
{
    /// <summary>
    /// Exposes the tools for XCOM2.
    /// </summary>
    public class XCOM2ToolLauncher : IToolLauncher
    {
		...
		public XCOM2ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
