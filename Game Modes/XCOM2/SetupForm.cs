...
{
	/// <summary>
	/// This is the setup form for the XCOM2 game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private XCOM2SetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as XCOM2SetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a XCOM2SetupVM. Type found: " + value.GetType().FullName);
