...
{
	/// <summary>
	/// This is the setup form for the SubnauticaBelowZero game mode.
	/// </summary>
	public partial class SetupForm : ManagedFontForm, IView
	{
        private SubnauticaBelowZeroSetupVM m_vmlViewModel = null;
		...
		public SetupBaseVM ViewModel
		{
			...
			private set
			{
                m_vmlViewModel = value as SubnauticaBelowZeroSetupVM;
				if (m_vmlViewModel == null)
					throw new ArgumentException("The given view model must be a SubnauticaBelowZeroSetupVM. Type found: " + value.GetType().FullName);
        ...
        public SetupForm(SubnauticaBelowZeroSetupVM p_vmlViewModel)
			: this()
		{
