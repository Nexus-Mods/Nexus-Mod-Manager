...
namespace Nexus.Client.Games.SubnauticaBelowZero
{
	...
	/// factories that build game modes for SubnauticaBelowZero based games.
	/// </summary>
	public class SubnauticaBelowZeroGameModeFactory : IGameModeFactory
	{
...
/// <value>The descriptor of the game mode that this factory builds.</value>
		...
		public SubnauticaBelowZeroGameModeFactory(IEnvironmentInfo p_eifEnvironmentInfo)
		{
			EnvironmentInfo = p_eifEnvironmentInfo;
			m_gmdGameModeDescriptor = new SubnauticaBelowZeroGameModeDescriptor(p_eifEnvironmentInfo);
		}
		...
		{
			string strValue = SteamInstallationPathDetector.Instance.GetSteamInstallationPath("848450", "SubnauticaZero", @"SubnauticaZero.exe");
		...
		public IGameMode BuildGameMode(FileUtil p_futFileUtility, out ViewMessage p_imsWarning)
		{
			...
			SubnauticaBelowZeroGameMode gmdGameMode = InstantiateGameMode(p_futFileUtility);
			p_imsWarning = null;
		...
		protected SubnauticaBelowZeroGameMode InstantiateGameMode(FileUtil p_futFileUtility)
		{
			return new SubnauticaBelowZeroGameMode(EnvironmentInfo, p_futFileUtility);
		}
		...
		public bool PerformInitialSetup(ShowViewDelegate p_dlgShowView, ShowMessageDelegate p_dlgShowMessage)
		{
			...
			SubnauticaBelowZeroSetupVM vmlSetup = new SubnauticaBelowZeroSetupVM(EnvironmentInfo, GameModeDescriptor);
