...
using Nexus.Client.Games.SubnauticaBelowZero.Settings.UI;
using Nexus.Client.Games.SubnauticaBelowZero.Tools;
...
{
	/// <summary>
	/// Provides information required for the program to manage SubnauticaBelowZero game's plugins and mods.
	/// </summary>
	public class SubnauticaBelowZeroGameMode : GameModeBase
	{
		private SubnauticaBelowZeroGameModeDescriptor m_gmdGameModeInfo = null;
		private SubnauticaBelowZeroLauncher m_glnGameLauncher = null;
		private SubnauticaBelowZeroToolLauncher m_gtlToolLauncher = null;
		...
		/// <summary>
		/// Gets the path to the per user SubnauticaBelowZero data.
		/// </summary>
		/// <value>The path to the per user SubnauticaBelowZero data.</value>
		...
		public override IGameLauncher GameLauncher
		{
			get
			{
				if (m_glnGameLauncher == null)
					m_glnGameLauncher = new SubnauticaBelowZeroLauncher(this, EnvironmentInfo);
		...
		public override IToolLauncher GameToolLauncher
		{
			get
			{
				if (m_gtlToolLauncher == null)
					m_gtlToolLauncher = new SubnauticaBelowZeroToolLauncher(this, EnvironmentInfo);
		...
		public SubnauticaBelowZeroGameMode(IEnvironmentInfo p_eifEnvironmentInfo, FileUtil p_futFileUtility)
		...
		protected override IGameModeDescriptor CreateGameModeDescriptor()
		{
			if (m_gmdGameModeInfo == null)
				m_gmdGameModeInfo = new SubnauticaBelowZeroGameModeDescriptor(EnvironmentInfo);
		...
		public override string GetModFormatAdjustedPath(IModFormat p_mftModFormat, string p_strPath, IMod p_modMod, bool p_booIgnoreIfPresent)
		{
			...
			if (!strPath.StartsWith("QMods"))
			{
				strPath = Path.Combine("QMods", strPath);
			}
