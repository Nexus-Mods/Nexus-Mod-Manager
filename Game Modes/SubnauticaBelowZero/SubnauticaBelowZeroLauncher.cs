...
{
	/// <summary>
	/// Launches SubnauticaBelowZero.
	/// </summary>
	public class SubnauticaBelowZeroLauncher : GameLauncherBase
	{
		#region Constructors
		...
		public SubnauticaBelowZeroLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		...
		/// </summary>
		private void LaunchSubnauticaBelowZeroCustom()
		{
			Trace.TraceInformation("Launching SubnauticaBelowZero (Custom)...");
			Trace.Indent();
		...
		/// </summary>
		private void LaunchSubnauticaBelowZeroPlain()
		{
			Trace.TraceInformation("Launching SubnauticaBelowZero (Default)...");
			Trace.Indent();
			string strCommand = GetPlainLaunchCommand();
		...
		{
			string strCommand = Path.Combine(GameMode.ExecutablePath, "SubnauticaBelowZero.exe");
			return strCommand;
		}
		...
		private void LaunchGame()
		{
			if (!string.IsNullOrEmpty(EnvironmentInfo.Settings.CustomLaunchCommands[GameMode.ModeId]))
				LaunchSubnauticaBelowZeroCustom();
			else
				LaunchSubnauticaBelowZeroPlain();
		}
