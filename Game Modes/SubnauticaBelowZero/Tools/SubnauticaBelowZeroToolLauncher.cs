...
namespace Nexus.Client.Games.SubnauticaBelowZero.Tools
{
	/// <summary>
	/// Exposes the tools for SubnauticaBelowZero.
	/// </summary>
	public class SubnauticaBelowZeroToolLauncher : IToolLauncher
	{
		...
		public SubnauticaBelowZeroToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
