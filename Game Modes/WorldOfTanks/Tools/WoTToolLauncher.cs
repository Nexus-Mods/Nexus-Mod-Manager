...
namespace Nexus.Client.Games.WorldOfTanks.Tools
{
    /// <summary>
    /// Exposes the tools for WorldOfTanks.
    /// </summary>
    public class WoTToolLauncher : IToolLauncher
    {
        ...
        public WoTToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
        {
