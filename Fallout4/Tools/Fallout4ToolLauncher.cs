...
using Nexus.Client.Games.Fallout4.Tools.AI;
using Nexus.Client.Games.Fallout4.Tools.AI.UI;
...
namespace Nexus.Client.Games.Fallout4.Tools
{
	...
	/// </summary>
	public class Fallout4ToolLauncher : IToolLauncher
	{
		...
		public Fallout4ToolLauncher(IGameMode p_gmdGameMode, IEnvironmentInfo p_eifEnvironmentInfo)
		{
		...
		protected void SetupTools()
		{
			...
			ArchiveInvalidation aitAI = new ArchiveInvalidation((Fallout4GameMode)GameMode);
