...
namespace Nexus.Client.Games
{
	...
	public interface IGameMode : IGameModeDescriptor, IDisposable
	{
		...
		string GetModFormatAdjustedPath(IModFormat p_mftModFormat, string p_strPath, ModPathContext p_mpcContext);
		...
		/// <param name="p_mpcContext">The path context to target.</param>
		/// <returns>The given path, adjusted for the requested path context.</returns>
		string GetModFormatAdjustedPath(IModFormat p_mftModFormat, string p_strPath, IMod p_modMod, ModPathContext p_mpcContext);
